...
window.B2P = (function () {
  ...
  const FASES = [
    ...
    { id: 4, nombre: 'Peak', sub: 'Push / Pull / Legs ×5', semanas: [10, 11, 12], disco: 25, rpe: '8',
      fechas: '19. Okt – 8. Nov',
      objetivo: 'Maximaler Reiz, um die Rekomposition abzuschließen. Fünf Tage, aber mit Sessions von 60-75 Minuten, nicht von 2 Stunden. RPE 8: 1-2 Wiederholungen in Reserve in den letzten Sätzen.' }
  ];
  ...
  const CARRERA = {
    titulo: 'Wie du läufst, ohne kaputtzugehen (95 kg geben den Ton an)',
    reglas: [
  ...
  const EJERCICIOS = {
    /* — Zuhause / P1 — */
    'sentadilla-pc': {
      nombre: 'Kniebeuge (Körpergewicht)', zona: 'pierna', musc: ['Quadrizeps', 'Gesäß'], equipo: 'Nichts',
    ...
    'flexiones': {
      nombre: 'Liegestütze', zona: 'empuje', musc: ['Brust', 'Trizeps, Schulter'], equipo: 'Nichts',
    ...
    'puente-gluteo': {
      nombre: 'Glute Bridge', zona: 'pierna', musc: ['Gesäß', 'Beinbizeps'], equipo: 'Nichts',
    ...
    'plancha': {
      nombre: 'Plank', zona: 'core', musc: ['Kompletter Core'], equipo: 'Nichts',
    ...
    'plancha-lastre': {
      nombre: 'Plank mit Zusatzgewicht', zona: 'core', musc: ['Kompletter Core'], equipo: 'Scheibe 5-10 kg',
    ...
    'elev-talones': {
      nombre: 'Wadenheben', zona: 'pierna', musc: ['Wade', 'Soleus'], equipo: 'Stufe optional',
    ...
    'zancada-alterna': {
      nombre: 'Ausfallschritte im Wechsel', zona: 'pierna', musc: ['Quadrizeps', 'Gesäß'], equipo: 'Nichts',
    ...
    'remo-toalla': {
      nombre: 'Handtuchrudern an der Tür', zona: 'tiron', musc: ['Lat', 'Bizeps, Schulterblätter'], equipo: 'Handtuch + Tür (oder Rucksack)',
    ...
    'rdl-1p': {
      nombre: 'Einbeiniges Rumänisches Kreuzheben', zona: 'pierna', musc: ['Beinbizeps', 'Gesäß, Balance'], equipo: 'Nichts (Rucksack optional)',
    ...
    'superman': {
      nombre: 'Superman', zona: 'core', musc: ['Unterer Rücken', 'Gesäß, oberer Rücken'], equipo: 'Nichts',
    ...
    'dead-bug': {
      nombre: 'Dead Bug', zona: 'core', musc: ['Tiefer vorderer Core'], equipo: 'Nichts',
    ...
    /* — Gym: Drücken — */
    'press-banca': {
      nombre: 'Bankdrücken', zona: 'empuje', musc: ['Brust', 'Trizeps, vordere Schulter'], equipo: 'Langhantel + Bank',
    ...
    'press-inclinado-mc': {
      nombre: 'Schrägbankdrücken mit Kurzhanteln', zona: 'empuje', musc: ['Obere Brust', 'Schulter, Trizeps'], equipo: 'Kurzhanteln + Bank 30°',
    ...
    'press-inclinado-barra': {
      nombre: 'Schrägbankdrücken mit Langhantel', zona: 'empuje', musc: ['Obere Brust', 'Schulter, Trizeps'], equipo: 'Langhantel + Schrägbank',
    ...
    'press-plano-mc': {
      nombre: 'Flachbankdrücken mit Kurzhanteln', zona: 'empuje', musc: ['Brust', 'Trizeps'], equipo: 'Kurzhanteln + Bank',
    ...
    'press-militar': {
      nombre: 'Schulterdrücken', zona: 'empuje', musc: ['Schulter', 'Trizeps, Core'], equipo: 'Langhantel (stehend oder sitzend)',
    ...
    'press-militar-mc': {
      nombre: 'Schulterdrücken mit Kurzhanteln sitzend', zona: 'empuje', musc: ['Schulter', 'Trizeps'], equipo: 'Kurzhanteln + Bank mit Lehne',
    ...
    'elev-laterales': {
      nombre: 'Seitheben', zona: 'empuje', musc: ['Seitliche Schulter'], equipo: 'Kurzhanteln',
    ...
    'laterales-polea': {
      nombre: 'Seitheben am Kabel', zona: 'empuje', musc: ['Seitliche Schulter'], equipo: 'Kabelzug unten',
    ...
    'fondos': {
      nombre: 'Dips (assistiert)', zona: 'empuje', musc: ['Untere Brust', 'Trizeps'], equipo: 'Dip-Maschine mit Unterstützung oder Bänder',
    ...
    'ext-triceps-polea': {
      nombre: 'Trizepsdrücken am Kabel', zona: 'empuje', musc: ['Trizeps'], equipo: 'Kabelzug oben + Seil oder Stange',
    ...
    'ext-triceps-cabeza': {
      nombre: 'Überkopf-Trizepsstrecken (Seil)', zona: 'empuje', musc: ['Trizeps (langer Kopf)'], equipo: 'Kabelzug + Seil',
    ...
    'press-frances': {
      nombre: 'Stirndrücken', zona: 'empuje', musc: ['Trizeps (langer Kopf)'], equipo: 'SZ-Stange + Bank',
    ...
    /* — Gym: Ziehen — */
    'remo-barra': {
      nombre: 'Langhantelrudern', zona: 'tiron', musc: ['Lat', 'mittlerer Rücken, Bizeps'], equipo: 'Langhantel',
    ...
    'remo-polea': {
      nombre: 'Rudern am Kabel sitzend', zona: 'tiron', musc: ['Mittlerer Rücken', 'Lat, Bizeps'], equipo: 'Kabelzug unten + Doppelgriff',
    ...
    'remo-mancuerna': {
      nombre: 'Einarmiges Kurzhantelrudern', zona: 'tiron', musc: ['Lat', 'mittlerer Rücken'], equipo: 'Kurzhantel + Bank',
    ...
    'jalon-pecho': {
      nombre: 'Latzug', zona: 'tiron', musc: ['Lat', 'Bizeps'], equipo: 'Kabelzug oben',
    ...
    'jalon-estrecho': {
      nombre: 'Latzug enger Griff', zona: 'tiron', musc: ['Lat', 'Bizeps'], equipo: 'Kabelzug oben + Doppelgriff',
    ...
    'dominadas': {
      nombre: 'Klimmzüge (assistiert → frei → mit Zusatzgewicht)', zona: 'tiron', musc: ['Lat', 'Bizeps, Core'], equipo: 'Stange + assistierte Maschine oder Bänder',
    ...
    'pullover-polea': {
      nombre: 'Pullover am Kabel', zona: 'tiron', musc: ['Lat (isoliert)'], equipo: 'Kabelzug oben + Stange oder Seil',
    ...
    'face-pull': {
      nombre: 'Face Pull', zona: 'tiron', musc: ['Hintere Schulter', 'Rotatoren, mittlerer Trapez'], equipo: 'Kabelzug oben + Seil',
    ...
    'encogimientos': {
      nombre: 'Shrugs mit Kurzhanteln', zona: 'tiron', musc: ['Oberer Trapez'], equipo: 'Kurzhanteln',
    ...
    /* — Gym: Beine/Hüfte — */
    'sentadilla-barra': {
      nombre: 'Langhantel-Kniebeuge', zona: 'pierna', musc: ['Quadrizeps', 'Gesäß, Core'], equipo: 'Langhantel + Rack',
    ...
    'prensa': {
      nombre: 'Beinpresse', zona: 'pierna', musc: ['Quadrizeps', 'Gesäß'], equipo: 'Beinpresse',
    ...
    'rdl-barra': {
      nombre: 'Rumänisches Kreuzheben', zona: 'pierna', musc: ['Beinbizeps', 'Gesäß, unterer Rücken isometrisch'], equipo: 'Langhantel',
    ...
    'hip-thrust': {
      nombre: 'Hip Thrust', zona: 'pierna', musc: ['Gesäß', 'Beinbizeps'], equipo: 'Langhantel + Bank (+ Polster)',
    ...
    'zancada-mc': {
      nombre: 'Ausfallschritte mit Kurzhanteln', zona: 'pierna', musc: ['Quadrizeps', 'Gesäß'], equipo: 'Kurzhanteln',
    ...
    'zancada-bulgara': {
      nombre: 'Bulgarian Split Squats', zona: 'pierna', musc: ['Quadrizeps', 'Gesäß'], equipo: 'Bank + Kurzhanteln',
    ...
    'ext-cuadriceps': {
      nombre: 'Beinstrecker', zona: 'pierna', musc: ['Quadrizeps (isoliert)'], equipo: 'Maschine',
    ...
    'curl-femoral-tumbado': {
      nombre: 'Beinbeuger liegend', zona: 'pierna', musc: ['Beinbizeps (isoliert)'], equipo: 'Maschine',
    ...
    'curl-femoral-sentado': {
      nombre: 'Beinbeuger sitzend', zona: 'pierna', musc: ['Beinbizeps (isoliert)'], equipo: 'Maschine',
    ...
    'gemelo-pie': {
      nombre: 'Wadenheben stehend', zona: 'pierna', musc: ['Wade (Gastrocnemius)'], equipo: 'Maschine oder Multipresse + Stufe',
    ...
    'gemelo-sentado': {
      nombre: 'Wadenheben sitzend', zona: 'pierna', musc: ['Soleus'], equipo: 'Maschine',
    ...
    'elev-piernas': {
      nombre: 'Beinheben hängend', zona: 'core', musc: ['Unterer Bauch', 'Hüftbeuger, Griffkraft'], equipo: 'Klimmzugstange',
    ...
    'rueda-abdominal': {
      nombre: 'Ab Wheel', zona: 'core', musc: ['Kompletter vorderer Core'], equipo: 'Ab Wheel',
    ...
    'crunch-polea': {
      nombre: 'Kabel-Crunch', zona: 'core', musc: ['Gerader Bauchmuskel'], equipo: 'Kabelzug oben + Seil',
    ...
    /* — Arme — */
    'curl-barra-z': {
      nombre: 'SZ-Curls', zona: 'tiron', musc: ['Bizeps'], equipo: 'SZ-Stange',
    ...
    'curl-inclinado': {
      nombre: 'Schrägbank-Curls', zona: 'tiron', musc: ['Bizeps (langer Kopf)'], equipo: 'Kurzhanteln + Bank 45-60°',
    ...
    'curl-martillo': {
      nombre: 'Hammercurls', zona: 'tiron', musc: ['Brachialis', 'Unterarm'], equipo: 'Kurzhanteln',
    ...
    'curl-polea': {
      nombre: 'Curls am Kabel', zona: 'tiron', musc: ['Bizeps'], equipo: 'Kabelzug unten + Stange',
  ...
  const REGLAS = [
    ...
    { n: 4, t: 'Protein: 190 g in 4 Portionen', d: 'Frühstück, Mittagessen, Abendessen und eine Portion vor dem Schlafen. Keine unter 38-40 g. Das ist die Variable, die entscheidet, ob die Kilos, die du verlierst, Fett sind oder Muskel.' },
  ...
  const NUTRI = {
    ...
    escalado: 'Das Protein wird nie angerührt: 190 g ≈ 2,5 g/kg Magermasse, der Bereich, den die Evidenz im Defizit verlangt (Helms 2014). Steigt das Trainingsvolumen, steigen nur die Kohlenhydrate. In der Praxis: In P3 kommen an Trainingstagen ein Stück Obst + 40 g Brot zum Mittagessen dazu; in P4 genau das an allen Tagen.',
    tomas: 'VIER Proteinportionen am Tag, keine unter 38-40 g: Frühstück, Mittagessen, Abendessen und eine Pre-Sleep-Portion (Skyr + Whey). Die Tagessumme regiert, aber die Aufteilung auf 4 presst das Maximum aus der Proteinsynthese und nimmt den Nachthunger.',
    plato: [
    ...
    suplementos: [
      ...
      { t: 'KEIN Geld für', d: 'Fatburner, BCAA/EAA (überflüssig bei 190 g Protein), „Testo-Booster". Nichts davon bewegt die Nadel.' }
    ],
  ...
  const LOGROS = [
    ...
    { id: 'dominada-libre', icon: '🦍', nombre: 'Freier Klimmzug',    desc: 'Erster Klimmzug ohne Unterstützung. Willkommen zurück.' },
    { id: 'mealprep-4',     icon: '🍱', nombre: 'Sonntagskoch',       desc: '4 Sonntage Meal Prep in Folge.' },
    { id: 'comeback',       icon: '🔁', nombre: 'Das Comeback',       desc: 'Zurückgekommen nach 4 oder mehr Tagen Pause. Zurückkommen zählt mehr als Hinfallen.' },
  ...
  const CIENCIA = {
    ...
    temas: [
      ...
      { t: 'Laufen mit 95 kg', d: 'Mit Übergewicht mehr als 3 km/Woche Joggen zu starten, lässt die Verletzungen hochschnellen (~31-48% mehr). Die Kadenz auf 170-180 zu heben senkt den Aufprall im Schienbein um ~11%. Die sichere Progression ist nicht die „10%-Regel": Es ist, ~1,3× deines Schnitts der letzten 4 Wochen nicht zu überschreiten.', ref: 'Bertelsen 2018 (RCT mit übergewichtigen Laufanfängern) · Kadenz-Review 2025 · IOC-Konsens zur Belastungssteuerung' },
      ...
      { t: 'Protein', d: 'Im Defizit brauchen Trainierte 2,3-3,1 g/kg Magermasse. 190 g setzen dich bequem in den Bereich, und die Aufteilung auf 4 Portionen ≥40 g presst das Maximum aus der Proteinsynthese und kontrolliert den Hunger.', ref: 'Helms 2014 (systematisches Review) · Schoenfeld & Aragon (Verteilung pro Portion)' },
  ...
  const AVISO_LEGAL = 'Plan erstellt am 13. Aug 2026 (v2, am selben Tag gegen die wissenschaftliche Evidenz geprüft) mit den Daten: Mann, 30 Jahre, 183 cm, 95,1 kg, Handgelenk 16,1 cm, sitzender Ausgangspunkt mit Hochleistungs-Vergangenheit. kcal- und Makro-Schätzungen mit ±10% Spielraum: Die Anpassungsregeln korrigieren diesen Spielraum mit echten Daten. Ersetzt keinen ärztlichen Rat; bei jeder Erkrankung oder anhaltendem Schmerz wende dich an medizinisches Fachpersonal.';
  ...
  const UI = {
    ...
    preplanSub: 'Montag, 17. August · Phase 1 zuhause. Bis dahin bring die Baseline unter Dach:',
    ...
    practicaMenu: 'Du kannst das Menü ab sofort üben: Am Montag, dem 17., wird es ernst.',
    ...
    cuest: {
      ...
      histT: 'Wo kommst du her?', histP: 'Der Wiedereinstieg wird anders geplant: die Sehne gibt das Tempo vor.', histNunca: 'Nie trainiert', histRetoma: 'Zurück nach Jahren Pause', histActivo: 'Trainiere gerade',
    ...
    nDietBreakTitulo: 'Diese Woche: DIET BREAK', nDietBreakTxt: '~2.800 kcal: +2 Portionen Kohlenhydrate am Tag. Protein gleich. Training gleich.',
    ...
    pMediaS: 'Schnitt W{w}', pSinDatos: 'keine Daten', pDesde: 'seit 95,1', pCinturaSub: '{f} · Ziel <91', pCinturaLunes: 'montags nüchtern',
    ...
    pCinturaTitulo: 'Taille', pCinturaTituloSub: 'die Königsmetrik · Ziel <91 cm',
    ...
    pTuMarca: 'deine Bestmarke · {v} kg', pMeta91: 'Ziel 91', pAguaCreatina: 'Kreatin-Wasser', pLineaBase: 'Baseline',
    ...
    ajPeligro: 'Gefahrenzone', ajBorrar: 'Alle Daten löschen', ajBorrarConfirma: 'Sicher? Tipp noch einmal, um ALLES zu löschen',
  ...
  UI.checkSalidaTitulo = 'Abschlusscheck (So, 30. Aug)';
  ...
  UI.planEmpiezaTitulo = 'Der Plan startet am Montag, dem 17. August';
