...
window.B2P = (function () {
  ...
  const LOGROS = [
    ...
    { id: 'racha-14',       icon: '🔥', nombre: 'Serie 14',           desc: '14 Plantage in Folge. Das On/Off-Muster ist tot.' },
  ...
  const CIENCIA = {
    ...
    temas: [
      ...
      { t: 'Diet Break', d: 'Defizit im Wechsel mit Erhaltungspausen dämpfte in der MATADOR-Studie den Stoffwechselabfall und verbesserte den Fettverlust. In {s} Wochen liegt sein Hauptwert für dein On/Off-Profil woanders: Er lehrt dich, dass EINE Woche Pause mit Plan kein Rückfall ist.', ref: 'Byrne 2018 (Int J Obesity, MATADOR)' },
