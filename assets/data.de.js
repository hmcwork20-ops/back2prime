...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilCinturaAdd: '+ Taille hinzufügen', perfilCinturaNota: 'Sie wird deine Basislinie und schaltet Taillenziel und -erfolge frei. Der Rest des Plans ändert sich nicht.', cerrarSesion: 'Abmelden', cerrarSesionNota: 'Zurück zur Eingangstür. Plan und Einträge bleiben auf diesem Gerät gespeichert.', perfilT: 'Mein Profil', perfilDatosT: 'Deine Antworten', perfilPlanT: 'Dein Plan, kurz', ajustes: 'Einstellungen', ajustesSub: 'BACK2PRIME · deine Daten leben NUR auf diesem Gerät',
