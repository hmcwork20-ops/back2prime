...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilT: 'Mein Profil', perfilDatosT: 'Deine Antworten', perfilPlanT: 'Dein Plan, kurz', ajustes: 'Einstellungen', ajustesSub: 'BACK2PRIME · deine Daten leben NUR auf diesem Gerät',
