...
window.B2P = (function () {
  ...
  const UI = {
    ...
    extraChip: 'Extra P{f}: ein Stück Obst + 40 g Brot zum Mittagessen.', sugRepite: '↻ wiederhol {v}',
