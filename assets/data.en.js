...
window.B2P = (function () {
  ...
  const REGLAS = [
    ...
    { n: 8, t: 'The non-negotiable minimum', d: 'Your historic pattern is 3 months all-in / 3 at zero. A chaotic week has a floor: 2 strength + 1 cardio. That keeps everything alive.' }
  ];
  ...
  const LOGROS = [
    ...
    { id: 'racha-7',        icon: '🔥', nombre: 'Streak 7',           desc: '7 days in a row closing the day.' },
    { id: 'racha-14',       icon: '🔥', nombre: 'Streak 14',          desc: '14 days in a row. The on/off pattern is dead.' },
    { id: 'racha-30',       icon: '🌋', nombre: 'Streak 30',          desc: '30 days in a row. Unstoppable.' },
  ...
  const CIENCIA = {
    ...
    temas: [
      ...
      { t: 'Health first', d: 'After 5 sedentary years at BMI 28, before the vigorous work of P3-P4: blood pressure and a basic blood panel (lipids, glucose/HbA1c). With symptoms of any kind, a doctor before carrying on.', ref: 'ACSM Preparticipation Health Screening' }
    ]
  };
  ...
  const UI = {
    ...
    ajustes: 'Settings', ajustesSub: 'BACK2PRIME · your data lives ONLY on this device',
    ...
    ajRehacer: 'Create / redo my plan', ajRehacerNota: 'Takes you to the questionnaire. Regenerating never touches your daily logs.', ajPeligro: 'Danger zone', ajBorrar: 'Delete all data', ajBorrarConfirma: 'Sure? Tap again to delete EVERYTHING',
