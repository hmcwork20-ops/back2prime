...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilCinturaAdd: '+ Add waist', perfilCinturaNota: 'It becomes your baseline and unlocks the waist goal and badges. The rest of the plan does not change.', cerrarSesion: 'Log out', cerrarSesionNota: 'Back to the front door. Your plan and logs stay saved on this device.', perfilT: 'My profile', perfilDatosT: 'Your answers', perfilPlanT: 'Your plan, in short', ajustes: 'Settings', ajustesSub: 'BACK2PRIME · your data lives ONLY on this device',
