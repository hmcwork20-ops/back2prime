...
window.B2P = (function () {
  ...
  const LOGROS = [
    ...
    { id: 'racha-14',       icon: '🔥', nombre: 'Série de 14',        desc: '14 jours de plan d’affilée. Le schéma on/off est mort.' },
