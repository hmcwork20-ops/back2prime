...
window.B2P = (function () {
  ...
  const EJERCICIOS = {
    /* — Maison / P1 — */
    'sentadilla-pc': {
      nombre: 'Squat au poids du corps', zona: 'pierna', musc: ['Quadriceps', 'fessier'], equipo: 'Rien',
    ...
    'flexiones': {
      nombre: 'Pompes', zona: 'empuje', musc: ['Pectoraux', 'triceps, épaules'], equipo: 'Rien',
    ...
    'puente-gluteo': {
      nombre: 'Pont fessier', zona: 'pierna', musc: ['Fessier', 'ischios'], equipo: 'Rien',
    ...
    'plancha': {
      nombre: 'Planche', zona: 'core', musc: ['Core complet'], equipo: 'Rien',
    ...
    'plancha-lastre': {
      nombre: 'Planche lestée', zona: 'core', musc: ['Core complet'], equipo: 'Disque 5-10 kg',
    ...
    'elev-talones': {
      nombre: 'Élévations de mollets', zona: 'pierna', musc: ['Mollet', 'soléaire'], equipo: 'Marche optionnelle',
    ...
    'zancada-alterna': {
      nombre: 'Fentes alternées', zona: 'pierna', musc: ['Quadriceps', 'fessier'], equipo: 'Rien',
    ...
    'remo-toalla': {
      nombre: 'Rowing serviette sur porte', zona: 'tiron', musc: ['Dorsaux', 'biceps, omoplates'], equipo: 'Serviette + porte (ou sac à dos)',
    ...
    'rdl-1p': {
      nombre: 'Soulevé de terre roumain à 1 jambe', zona: 'pierna', musc: ['Ischios', 'fessier, équilibre'], equipo: 'Rien (sac à dos optionnel)',
    ...
    'superman': {
      nombre: 'Superman', zona: 'core', musc: ['Lombaires', 'fessier, haut du dos'], equipo: 'Rien',
    ...
    'dead-bug': {
      nombre: 'Dead bug', zona: 'core', musc: ['Core antérieur profond'], equipo: 'Rien',
    ...
    /* — Salle : poussée — */
    'press-banca': {
      nombre: 'Développé couché', zona: 'empuje', musc: ['Pectoraux', 'triceps, deltoïde antérieur'], equipo: 'Barre + banc',
    ...
    'press-inclinado-mc': {
      nombre: 'Développé incliné haltères', zona: 'empuje', musc: ['Haut des pectoraux', 'épaules, triceps'], equipo: 'Haltères + banc 30°',
    ...
    'press-inclinado-barra': {
      nombre: 'Développé incliné barre', zona: 'empuje', musc: ['Haut des pectoraux', 'épaules, triceps'], equipo: 'Barre + banc incliné',
    ...
    'press-plano-mc': {
      nombre: 'Développé couché haltères', zona: 'empuje', musc: ['Pectoraux', 'triceps'], equipo: 'Haltères + banc',
    ...
    'press-militar': {
      nombre: 'Développé militaire', zona: 'empuje', musc: ['Épaules', 'triceps, core'], equipo: 'Barre (debout ou assis)',
    ...
    'press-militar-mc': {
      nombre: 'Développé militaire haltères assis', zona: 'empuje', musc: ['Épaules', 'triceps'], equipo: 'Haltères + banc à dossier',
    ...
    'elev-laterales': {
      nombre: 'Élévations latérales', zona: 'empuje', musc: ['Deltoïde latéral'], equipo: 'Haltères',
    ...
    'laterales-polea': {
      nombre: 'Élévations latérales à la poulie', zona: 'empuje', musc: ['Deltoïde latéral'], equipo: 'Poulie basse',
    ...
    'fondos': {
      nombre: 'Dips assistés', zona: 'empuje', musc: ['Bas des pectoraux', 'triceps'], equipo: 'Machine à dips assistés ou élastiques',
    ...
    'ext-triceps-polea': {
      nombre: 'Extension triceps à la poulie', zona: 'empuje', musc: ['Triceps'], equipo: 'Poulie haute + corde ou barre',
    ...
    'ext-triceps-cabeza': {
      nombre: 'Extension nuque à la corde', zona: 'empuje', musc: ['Triceps (chef long)'], equipo: 'Poulie + corde',
    ...
    'press-frances': {
      nombre: 'Barre au front', zona: 'empuje', musc: ['Triceps (chef long)'], equipo: 'Barre EZ + banc',
    ...
    /* — Salle : tirage — */
    'remo-barra': {
      nombre: 'Rowing barre', zona: 'tiron', musc: ['Dorsaux', 'milieu du dos, biceps'], equipo: 'Barre',
    ...
    'remo-polea': {
      nombre: 'Rowing assis à la poulie', zona: 'tiron', musc: ['Milieu du dos', 'dorsaux, biceps'], equipo: 'Poulie basse + triangle',
    ...
    'remo-mancuerna': {
      nombre: 'Rowing haltère à 1 bras', zona: 'tiron', musc: ['Dorsaux', 'milieu du dos'], equipo: 'Haltère + banc',
    ...
    'jalon-pecho': {
      nombre: 'Tirage vertical', zona: 'tiron', musc: ['Dorsaux', 'biceps'], equipo: 'Poulie haute',
    ...
    'jalon-estrecho': {
      nombre: 'Tirage vertical prise serrée', zona: 'tiron', musc: ['Dorsaux', 'biceps'], equipo: 'Poulie haute + triangle',
    ...
    'dominadas': {
      nombre: 'Tractions (assistées → libres → lestées)', zona: 'tiron', musc: ['Dorsaux', 'biceps, core'], equipo: 'Barre + machine assistée ou élastiques',
    ...
    'pullover-polea': {
      nombre: 'Pullover à la poulie', zona: 'tiron', musc: ['Dorsaux (isolés)'], equipo: 'Poulie haute + barre ou corde',
    ...
    'face-pull': {
      nombre: 'Face pull', zona: 'tiron', musc: ['Deltoïde postérieur', 'rotateurs, trapèze moyen'], equipo: 'Poulie haute + corde',
    ...
    'encogimientos': {
      nombre: 'Shrugs haltères', zona: 'tiron', musc: ['Trapèze supérieur'], equipo: 'Haltères',
    ...
    'sentadilla-barra': {
      nombre: 'Squat barre', zona: 'pierna', musc: ['Quadriceps', 'fessier, core'], equipo: 'Barre + rack',
    ...
    'prensa': {
      nombre: 'Presse à cuisses', zona: 'pierna', musc: ['Quadriceps', 'fessier'], equipo: 'Machine à presse',
    ...
    'rdl-barra': {
      nombre: 'Soulevé de terre roumain', zona: 'pierna', musc: ['Ischios', 'fessier, lombaires en isométrique'], equipo: 'Barre',
    ...
    'hip-thrust': {
      nombre: 'Hip thrust', zona: 'pierna', musc: ['Fessier', 'ischios'], equipo: 'Barre + banc (+ protection)',
    ...
    'zancada-mc': {
      nombre: 'Fentes haltères', zona: 'pierna', musc: ['Quadriceps', 'fessier'], equipo: 'Haltères',
    ...
    'zancada-bulgara': {
      nombre: 'Fentes bulgares', zona: 'pierna', musc: ['Quadriceps', 'fessier'], equipo: 'Banc + haltères',
    ...
    'ext-cuadriceps': {
      nombre: 'Leg extension', zona: 'pierna', musc: ['Quadriceps (isolés)'], equipo: 'Machine',
    ...
    'curl-femoral-tumbado': {
      nombre: 'Leg curl allongé', zona: 'pierna', musc: ['Ischios (isolés)'], equipo: 'Machine',
    ...
    'curl-femoral-sentado': {
      nombre: 'Leg curl assis', zona: 'pierna', musc: ['Ischios (isolés)'], equipo: 'Machine',
    ...
    'gemelo-pie': {
      nombre: 'Mollets debout', zona: 'pierna', musc: ['Mollet (gastrocnémien)'], equipo: 'Machine ou Smith machine + marche',
    ...
    'gemelo-sentado': {
      nombre: 'Mollets assis', zona: 'pierna', musc: ['Soléaire'], equipo: 'Machine',
    ...
    'elev-piernas': {
      nombre: 'Relevés de jambes suspendu', zona: 'core', musc: ['Bas des abdos', 'fléchisseurs, grip'], equipo: 'Barre de tractions',
    ...
    'rueda-abdominal': {
      nombre: 'Roulette abdominale', zona: 'core', musc: ['Core antérieur complet'], equipo: 'Ab wheel',
    ...
    'crunch-polea': {
      nombre: 'Crunch à la poulie', zona: 'core', musc: ['Grand droit'], equipo: 'Poulie haute + corde',
    ...
    /* — Bras — */
    'curl-barra-z': {
      nombre: 'Curl barre EZ', zona: 'tiron', musc: ['Biceps'], equipo: 'Barre EZ',
    ...
    'curl-inclinado': {
      nombre: 'Curl incliné haltères', zona: 'tiron', musc: ['Biceps (chef long)'], equipo: 'Haltères + banc 45-60°',
    ...
    'curl-martillo': {
      nombre: 'Curl marteau', zona: 'tiron', musc: ['Brachial', 'avant-bras'], equipo: 'Haltères',
    ...
    'curl-polea': {
      nombre: 'Curl à la poulie basse', zona: 'tiron', musc: ['Biceps'], equipo: 'Poulie basse + barre',
  ...
  const RECETAS = [
    {
      id: 'bol-skyr', nombre: 'Bol de skyr', tipo: 'Petit-déj A', tiempo: '5′', cocina: 'Sans cuisson',
    ...
    {
      id: 'tortilla-pan', nombre: 'Omelette, pain et tomate', tipo: 'Petit-déj B', tiempo: '10′', cocina: 'Poêle',
    ...
    {
      id: 'pollo-asado', nombre: 'Poulet rôti et pommes de terre', tipo: 'Déjeuner · batch du dimanche', tiempo: '45′ de four (du meal prep)', cocina: 'Four',
    ...
    {
      id: 'lentejas-pollo', nombre: 'Lentilles au poulet', tipo: 'Déjeuner · batch du dimanche', tiempo: '25′ de casserole', cocina: 'Casserole',
    ...
    {
      id: 'salteado-ternera', nombre: 'Sauté de bœuf', tipo: 'Déjeuner · 15′ frais', tiempo: '15′', cocina: 'Wok / poêle',
    ...
    {
      id: 'salmon-arroz', nombre: 'Saumon, riz et brocoli', tipo: 'Dîner · 15′', tiempo: '15′', cocina: 'Poêle ou four',
    ...
    {
      id: 'merluza-patata', nombre: 'Colin et pommes de terre boulangères', tipo: 'Dîner · 20′', tiempo: '20′', cocina: 'Four ou micro-ondes+poêle',
    ...
    {
      id: 'revuelto-gambas', nombre: 'Brouillade aux crevettes', tipo: 'Dîner · 10′', tiempo: '10′', cocina: 'Poêle',
    ...
    {
      id: 'toma-noche', nombre: 'Prise pré-sommeil', tipo: 'Prise 4 · quotidienne', tiempo: '1′', cocina: 'Sans cuisson',
    ...
    {
      id: 'ensalada-atun', nombre: 'Salade complète au thon', tipo: 'Dîner · 10′', tiempo: '10′', cocina: 'Sans feu (avec le batch)',
