...
window.B2P = (function () {
  ...
  const UI = {
    ...
    alta: { t: 'Crée ton profil', sub: 'Reviens à ta meilleure version. Ton plan d’entraînement et de nutrition.', nombreL: 'Ton prénom', ph: 'Comment on t’appelle ?', cta: 'Commencer', local: 'Tes données vivent uniquement sur cet appareil.', valNombre: 'Écris un prénom de 2 à 24 caractères.', idioma: 'Langue' },
