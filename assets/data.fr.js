...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilT: 'Mon profil', perfilDatosT: 'Tes réponses', perfilPlanT: 'Ton plan, en bref', ajustes: 'Réglages', ajustesSub: 'BACK2PRIME · tes données vivent UNIQUEMENT sur cet appareil',
