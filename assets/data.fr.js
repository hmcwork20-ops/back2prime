...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilCinturaAdd: '+ Ajouter le tour de taille', perfilCinturaNota: 'Il devient ta ligne de base et active l’objectif et les succès de tour de taille. Le reste du plan ne change pas.', perfilT: 'Mon profil', perfilDatosT: 'Tes réponses', perfilPlanT: 'Ton plan, en bref', ajustes: 'Réglages', ajustesSub: 'BACK2PRIME · tes données vivent UNIQUEMENT sur cet appareil',
    ...
    ajRehacer: 'Créer / refaire mon plan', ajRehacerNota: 'Direction le questionnaire. Régénérer ne touche jamais tes registres quotidiens.', ajPeligro: 'Zone dangereuse', ajBorrar: 'Effacer toutes les données', ajBorrarConfirma: 'Sûr ? Touche encore une fois pour TOUT effacer',
