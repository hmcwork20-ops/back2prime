...
window.B2P = (function () {
  ...
  const UI = {
    ...
    cuest: {
      ...
      histT: 'Da dove vieni?', histP: 'Il rientro si programma diversamente: comanda il tendine.', histNunca: 'Mai allenato', histRetoma: 'Torno dopo anni fermo', histActivo: 'Mi alleno ora',
