...
window.B2P = (function () {
  ...
  const UI = {
    ...
    alta: { t: 'Crea il tuo profilo', sub: 'Torna alla tua versione migliore. Il tuo piano di allenamento e nutrizione.', nombreL: 'Il tuo nome', ph: 'Come ti chiamiamo?', cta: 'Inizia', local: 'I tuoi dati vivono solo su questo dispositivo.', valNombre: 'Scrivi un nome da 2 a 24 caratteri.', idioma: 'Lingua' },
