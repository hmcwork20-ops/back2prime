...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilCinturaAdd: '+ Aggiungi girovita', perfilCinturaNota: 'Diventa la tua linea di base e attiva la meta e i traguardi di girovita. Il resto del piano non cambia.', perfilT: 'Il mio profilo', perfilDatosT: 'Le tue risposte', perfilPlanT: 'Il tuo piano, in breve', ajustes: 'Impostazioni', ajustesSub: 'BACK2PRIME · i tuoi dati vivono SOLO su questo dispositivo',
    ...
    ajRehacer: 'Crea / rifai il mio piano', ajRehacerNota: 'Ti porta al questionario. Rigenerare non tocca mai i tuoi registri giornalieri.', ajPeligro: 'Zona pericolosa', ajBorrar: 'Cancella tutti i dati', ajBorrarConfirma: 'Sicuro? Tocca di nuovo per cancellare TUTTO',
