...
window.B2P = (function () {
  ...
  const UI = {
    ...
    rev: { t: '{n}, il tuo piano è pronto', tAnon: 'Il tuo piano è pronto', sub: 'Deciso dalle tue risposte. Questo non è un modello.',
