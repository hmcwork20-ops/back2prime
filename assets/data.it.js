...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilCinturaAdd: '+ Aggiungi girovita', perfilCinturaNota: 'Diventa la tua linea di base e attiva la meta e i traguardi di girovita. Il resto del piano non cambia.', cerrarSesion: 'Esci', cerrarSesionNota: 'Torni alla porta d’ingresso. Piano e registri restano salvati su questo dispositivo.', rehacerSub: 'Cosa vuoi rifare?', rehacerTodo: 'Questionario completo', rehacerTodoSub: 'Dati e gusti, da cima a fondo.', rehacerDatos: 'Solo i miei dati', rehacerDatosSub: 'Età, obiettivo, giorni, attrezzatura… Il mazzo non si tocca.', rehacerGustos: 'Solo i miei gusti', rehacerGustosSub: 'Il mazzo di carte, da zero.', perfilT: 'Il mio profilo', perfilDatosT: 'Le tue risposte', perfilPlanT: 'Il tuo piano, in breve', ajustes: 'Impostazioni', ajustesSub: 'BACK2PRIME · i tuoi dati vivono SOLO su questo dispositivo',
