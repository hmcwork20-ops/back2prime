...
window.B2P = (function () {
  ...
  const LOGROS = [
    ...
    { id: 'racha-14',       icon: '🔥', nombre: 'Striscia da 14',     desc: '14 giorni di piano di fila. Lo schema on/off è morto.' },
  ...
  const CIENCIA = {
    ...
    temas: [
      ...
      { t: 'Diet break', d: 'Alternare deficit e pause a mantenimento ha attenuato il calo metabolico e migliorato la perdita di grasso nello studio MATADOR. In {s} settimane il suo valore principale per il tuo profilo on/off è un altro: ti insegna che fermarti UNA settimana con un piano non è ricadere.', ref: 'Byrne 2018 (Int J Obesity, MATADOR)' },
  ...
  const UI = {
    ...
    rev: { minT: '{v} minuti a sessione', minSub: 'sessioni tagliate all’essenziale: i fondamentali restano', evT: 'Obiettivo: {e}', evSub: 'la data comanda: costanza sopra la perfezione', durOpen: 'Senza data: blocchi di {s} settimane, rinnovabili', t: '{n}, il tuo piano è pronto', tAnon: 'Il tuo piano è pronto', sub: 'Deciso dalle tue risposte. Questo non è un modello.',
    ...
    perfilCinturaAdd: '+ Aggiungi girovita', perfilCinturaNota: 'Diventa la tua linea di base e attiva la meta e i traguardi di girovita. Il resto del piano non cambia.', cerrarSesion: 'Esci', cerrarSesionNota: 'Torni alla porta d’ingresso. Piano e registri restano salvati su questo dispositivo.', rehacerSub: 'Cosa vuoi rifare?', rehacerTodo: 'Questionario completo', rehacerTodoSub: 'Dati e gusti, da cima a fondo.', rehacerDatos: 'Solo i miei dati', rehacerDatosSub: 'Età, obiettivo, giorni, attrezzatura… Il mazzo non si tocca.', rehacerGustos: 'Solo i miei gusti', rehacerGustosSub: 'Il mazzo di carte, da zero.', perfilDetrasT: 'Dietro il piano', buscarT: 'Cerca nell’app', buscarPH: 'Esercizio, piatto, sezione…', buscarNada: 'Niente con questo nome. Prova un’altra parola.', perfilT: 'Il mio profilo', perfilDatosT: 'Le tue risposte', perfilPlanT: 'Il tuo piano, in breve', ajustes: 'Impostazioni', ajustesSub: 'BACK2PRIME · i tuoi dati vivono SOLO su questo dispositivo',
