...
window.B2P = (function () {
  ...
  const REGLAS = [
    ...
    { n: 4, t: 'Proteína: {p} g en 4 tomas', d: 'Desayuno, comida, cena y pre-sueño, ninguna por debajo de {q} g. Decide si lo que cambia es grasa o músculo.' },
  ...
  const NUTRI = {
    ...
    escalado: 'La proteína ({p} g) no se toca: al subir el entreno solo sube el carbohidrato. En F3, +1 fruta y 40 g de pan en la comida los días de entreno; en F4, todos los días.',
    tomas: 'Cuatro tomas de proteína al día, ninguna por debajo de {q} g: desayuno, comida, cena y pre-sueño. El total manda, pero repartirlo en 4 exprime la síntesis y quita el hambre de noche.',
    plato: [
  ...
  const UI = {
    ...
    prepCintura: 'Cintura en ayunas, al ombligo',
    ...
    hCintura: 'Cintura (lunes)', hCinturaSub: 'La métrica reina · al ombligo',
    ...
    pVacioCintura: 'Cada lunes en ayunas, cinta al ombligo',
