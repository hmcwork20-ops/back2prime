...
window.B2P = (function () {
  ...
  const NUTRI = {
    ...
    suplementos: [
      { id: 'creatina', t: 'Creatina monohidrato', d: '5 g diarios, a cualquier hora, sin fase de carga, desde ya. AVISO: retiene 1-2 kg de agua las primeras semanas. No es grasa: fíate de la cintura y de la media semanal, no del número suelto (la app lo marca en la gráfica).' },
      { id: 'whey', t: 'Whey', d: '1 cazo en la toma pre-sueño con el skyr (y otro donde haga falta los días cortos de proteína).' },
      { id: 'cafeina', t: 'Cafeína', d: 'Corte a las 13-14 h: 200 mg alteran el sueño hasta 13 h después; un café, ~9 h (Gardiner 2023). Entreno de mañana: café 30-45′ antes, perfecto. De tarde-noche: sin cafeína — tu pre-entreno es la merienda (fruta + skyr 60-90′ antes).' },
      { id: 'vitamina-d', t: 'Vitamina D', d: 'Vitamina D solo si la analítica sale por debajo de 30 ng/mL (probable con vida de interior).' },
      { id: 'omega-3', t: 'Omega-3', d: 'Omega-3 ~2 g EPA+DHA/día: beneficio modesto pero real en fuerza y ángulo antiinflamatorio/tendón.' },
      { id: 'no', t: 'NO gastes en', d: 'Quemagrasas, BCAA/EAA (redundantes con tu proteína diaria), "testo boosters". Nada de eso mueve la aguja.' }
    ],
  ...
  const UI = {
    ...
    tour: { salta: 'Saltar', sigue: 'Siguiente', listo: 'A entrenar', otraVez: 'Repetir el tour de bienvenida',
      antes: ['Tu plan está en marcha', 'Empieza el día que elegiste. Hasta entonces, HOY te enseña los pasos previos y el menú ya está listo para que vayas comprando.'],
      pasos: [
      ['Esto es HOY', 'Tu día, ya montado: la sesión de hoy con sus ejercicios, series y descansos. Toca un ejercicio y verás la técnica y el músculo que trabaja.'],
      ['La comida de hoy', 'Desayuno, comida, cena y la toma de la noche, elegidos para tu objetivo. Toca un plato y sale la receta entera.'],
      ['Tu registro diario', 'Peso, cintura y lo que has cumplido. Un toque por hábito, y cierras el día con el botón de abajo. La app lleva la cuenta.'],
      ['El plan entero', 'Un calendario con cada fase en su color. Toca cualquier día y verás su entreno y sus comidas. Desliza o usa las flechas para cambiar de mes.'],
      ['Las cuatro fases', 'De la reactivación al pico. Cada banda dice sus semanas y su intensidad; despliégala y verás qué persigue.'],
      ['Tu biblioteca de ejercicios', 'Todos los movimientos por zona, con el músculo pintado, la técnica y qué usar si te falta material.'],
      ['Tu objetivo en la mesa', 'Calorías y macros de la fase en curso, y si el menú se queda corto o se pasa, cuánto. El porqué vive en Mi perfil.'],
      ['Recetario', 'Desayunos, comidas, cenas y suplementos, filtrados para ti. Cada receta con foto, ingredientes con su foto y paso a paso.'],
      ['La compra de la semana', 'Todo lo que necesitas, agrupado por comida y con la foto del producto para reconocerlo en el súper. Marca lo que ya tienes.'],
      ['Progreso honesto', 'Peso, cintura, cargas y constancia, en gráficas. Si vas demasiado rápido, la app te frena.'],
      ['Tus insignias', 'Se ganan con constancia, no con intensidad. Cada una explica qué hiciste para conseguirla.'],
      ['Dos burbujas', 'La lupa busca cualquier ejercicio, plato o ajuste. El bocadillo es para contarme fallos o ideas: los leo todos.'],
      ['Mi perfil', 'Tus respuestas, rehacer el plan, compartirlo por enlace, exportar tus datos, la privacidad y borrar la cuenta. Todo lo tuyo, ahí.'] ] },
    cuest: {
    ...
    rep: { t: 'Reportar', sub: '¿Algo falla o se te ocurre algo mejor? Cuéntamelo aquí.', bug: 'Falla algo', idea: 'Una idea', otro: 'Otra cosa', txtL: 'Cuéntamelo', ph: '¿Qué pasó? Si puedes, dime en qué pantalla estabas y qué esperabas que ocurriera.', enviar: 'Enviar', gracias: 'Recibido. Gracias por escribirlo.', corto: 'Escribe algo más para que se pueda entender.', repRitmo: 'Espera un minuto antes de enviar otro.', repCorto: 'Escribe algo más para que se pueda entender.', errRed: 'No se pudo enviar: revisa la conexión.', adjunta: 'Se adjunta versión, plataforma, idioma, pantalla y tamaño para poder reproducirlo. Nada de tu plan, tu peso ni tus registros.' },
    nube: { correoL: 'Correo', claveL: 'Contraseña (mínimo 8)', verClave: 'Mostrar contraseña', ocultarClave: 'Ocultar contraseña', previoT: 'Plan anterior en este dispositivo', previoTxt: 'Este dispositivo guardaba un plan de antes de que hubiera cuentas. No se trae solo, porque podría ser de otra persona. Si es tuyo, tráelo: reemplazará lo que tengas ahora.', previoCta: 'Traer ese plan', previoOk: 'Plan recuperado', entrar: 'Entrar', crear: 'Crear cuenta', aCrear: '¿Primera vez? Crea tu cuenta', aEntrar: '¿Ya tienes cuenta? Entra', olvide: 'He olvidado la contraseña', enviadoReset: 'Correo enviado: abre el enlace para cambiarla', nuevaClaveT: 'Elige una contraseña nueva', guardarClave: 'Guardar contraseña', cambiada: 'Contraseña cambiada: ya puedes entrar', confirmaCorreo: 'Revisa tu correo y confirma la cuenta; después entra aquí', yaExiste: 'Ese correo ya tiene cuenta: entra con tu contraseña', errCred: 'Correo o contraseña incorrectos', errCorreo: 'Escribe un correo válido', errClaveCorta: 'La contraseña necesita al menos 8 caracteres', errRitmo: 'Demasiados intentos seguidos: espera un momento', errRed: 'Sin conexión con el servidor: prueba de nuevo', local: 'Tu cuenta guarda tu plan y te sigue en cualquier dispositivo. Solo tú puedes verlo.', ajustesSub: 'BACK2PRIME · tu plan vive en tu cuenta y solo tú puedes verlo', cerrarSesionNota: 'Vuelves a la puerta de entrada. Tu plan queda en tu cuenta: entra de nuevo y sigues donde ibas.' },
