...
window.B2P = (function () {
  ...
  const UI = {
    ...
    alta: { t: 'Crea tu usuario', sub: 'Fuerza, comida y progreso. Tu plan, en dos minutos.', nombreL: 'Tu nombre', ph: '¿Cómo te llamamos?', cta: 'Empezar', local: 'Tus datos viven solo en este dispositivo.', valNombre: 'Escribe un nombre de 2 a 24 letras.', idioma: 'Idioma' },
