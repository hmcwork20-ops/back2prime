...
window.B2P = (function () {
  ...
  const UI = {
    ...
    perfilCinturaAdd: '+ Añadir cintura', perfilCinturaNota: 'Se convierte en tu línea base y activa la meta y los logros de cintura. El resto del plan no cambia.', cerrarSesion: 'Cerrar sesión', cerrarSesionNota: 'Vuelves a la puerta de entrada. Tu plan y tus registros se quedan guardados en este dispositivo.', perfilT: 'Mi perfil', perfilDatosT: 'Tus respuestas', perfilPlanT: 'Tu plan, en corto', ajustes: 'Ajustes', ajustesSub: 'BACK2PRIME · tus datos viven SOLO en este dispositivo',
