...
window.B2P = (function () {
  ...
  const LOGROS = [
    ...
    { id: 'racha-14',       icon: '🔥', nombre: 'Racha 14',          desc: '14 días de plan seguidos. El patrón on/off está muerto.' },
  ...
  const CIENCIA = {
    ...
    temas: [
      ...
      { t: 'Diet break', d: 'Alternar déficit con descansos a mantenimiento atenuó la caída metabólica y mejoró la pérdida de grasa en el estudio MATADOR. En {s} semanas su valor principal para tu perfil on/off es otro: te enseña que parar UNA semana con plan no es recaer.', ref: 'Byrne 2018 (Int J Obesity, MATADOR)' },
  ...
  const UI = {
    ...
    rev: { minT: '{v} minutos por sesión', minSub: 'sesiones recortadas a lo esencial: los básicos se quedan', evT: 'Objetivo: {e}', evSub: 'la fecha manda: constancia por encima de perfección', durOpen: 'Sin fecha: bloques de {s} semanas, renovables', t: '{n}, tu plan está listo', tAnon: 'Tu plan está listo', sub: 'Decidido con tus respuestas. Esto no es una plantilla.',
    ...
    vSeguros: 'Los seguros del plan', vBiblioteca: 'Biblioteca de ejercicios', vTocaCualquiera: 'toca cualquiera',
    ...
    perfilCinturaAdd: '+ Añadir cintura', perfilCinturaNota: 'Se convierte en tu línea base y activa la meta y los logros de cintura. El resto del plan no cambia.', perfilT: 'Mi perfil', perfilDatosT: 'Tus respuestas', perfilPlanT: 'Tu plan, en corto', ajustes: 'Ajustes', ajustesSub: 'BACK2PRIME · tus datos viven SOLO en este dispositivo',
    ...
    ajRehacer: 'Crear / rehacer mi plan', ajRehacerNota: 'Te lleva al cuestionario. Al generar de nuevo, tus registros diarios no se tocan.', ajPeligro: 'Zona peligrosa', ajBorrar: 'Borrar todos los datos', ajBorrarConfirma: '¿Seguro? Toca otra vez para borrar TODO',
