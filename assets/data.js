...
window.B2P = (function () {
  ...
  const FASES = [
    { id: 1, nombre: 'Reactivación', sub: 'En casa', semanas: [1, 2], disco: 10, rpe: '6–7',
      fechas: '17 – 30 ago',
      objetivo: 'Recuperar el hábito y los patrones sin castigar articulaciones. Te quedarás con ganas: es intencionado.' },
    { id: 2, nombre: 'Entrada al gym', sub: 'Full Body ×3', semanas: [3, 4, 5], disco: 15, rpe: '6–7',
      fechas: '31 ago – 20 sep',
      objetivo: 'Básicos con barra y base de carga. Tu memoria muscular permite pesos que el tejido conectivo aún no aguanta: 65-70% de lo que podrías, 3 repeticiones reales en reserva.' },
    { id: 3, nombre: 'Carga', sub: 'Torso / Pierna ×4', semanas: [6, 7, 8, 9], disco: 20, rpe: '7–8',
      fechas: '21 sep – 18 oct',
      objetivo: 'Volumen e intensidad reales; aquí rinde la memoria muscular. Termina cada serie con 2 repeticiones reales en reserva: quien vuelve se cree más cerca del fallo de lo que está.' },
    { id: 4, nombre: 'Pico', sub: 'Push / Pull / Legs ×5', semanas: [10, 11, 12], disco: 25, rpe: '8',
      fechas: '19 oct – 8 nov',
      objetivo: 'Máximo estímulo para cerrar. {d} días de {min} minutos, no de 2 horas. RPE 8: 1-2 repeticiones reales en reserva en las últimas series.' }
  ];
  ...
  const SESIONES = {
    ...
    /* — Cardio — */
    'cam40':  { nombre: 'Caminata 40′', tipo: 'cardio', icono: 'walk', detalle: 'Puedes hablar, no cantar. Cuenta para los pasos del día.' },
    ...
    'wj3': { nombre: 'Caminar-trotar S3', tipo: 'cardio', icono: 'run', detalle: '7 rondas: 2′ trote suave + 2′ andando (28′). Antes: 2×20 tibialis raises y 10 elevaciones de talón. Si no puedes hablar, vas rápido.' },
    ...
    'trote25': { nombre: 'Trote 25-30′', tipo: 'cardio', icono: 'run', detalle: 'Continuo, a ritmo de conversación. Mejor asfalto liso o tierra que aceras. Molestia en espinilla o rodilla que empeora: corta y camina.' },
    ...
    'libre': { nombre: 'Descanso', tipo: 'libre', icono: 'rest', detalle: 'Libre de verdad; los pasos siguen contando. Domingo: meal prep (~90′) y semana resuelta.' }
  };
  ...
  const TENDON = {
    ...
    intro: 'La fuerza vuelve en semanas; el tendón necesita meses: su colágeno se renueva ~10 veces más lento y no tiene memoria. Este bloque es el seguro del plan: empieza la semana 1, y el trote de la semana 3 solo entra con dos semanas de tendón rodadas.',
    bloques: [
      { id: 'tendon-rodilla', nombre: 'Rotuliano · isométrico', donde: 'Tras cada sesión de pierna (en F1, tras los circuitos)',
        detalle: 'Sentadilla isométrica en pared (desde F2, española con cinta rígida tras las rodillas): 5 × 45″ al 70% de esfuerzo, 1′ de descanso. Muslo cerca del paralelo, sin dolor punzante. Además quita dolor al momento.' },
      { id: 'tendon-aquiles', nombre: 'Aquiles · HSR de gemelo', donde: 'Ya integrado en las sesiones (elevaciones/gemelo)',
        detalle: 'Gemelo pesado y lento: 3″ bajar, 3″ subir, 6-8 reps, sin rebote. En F1 con mochila a una pierna; en gym con carga real. El rebote usa el reflejo del tendón y le quita el estímulo que necesita.' },
      ...
      { id: 'tendon-codo', nombre: 'Codo/muñeca · isométrico', donde: 'Tras las sesiones de torso (F2+), 2×/sem',
        detalle: 'Mancuerna ligera, muñeca quieta a media flexión: 3 × 45″, palma arriba y palma abajo. Tanto press, remo y jalón dispara epicondilitis; esto la previene.' }
    ],
    nota: 'No añadas saltos «para preparar el trote»: es mal estímulo para el tendón y alto impacto. Tu preparación de impacto es este bloque.'
  };
  ...
  const CARRERA = {
    ...
    reglas: [
      'Cadencia 170-180 pasos/min y zancada corta: ~11% menos impacto tibial, ~15% menos tasa de carga. Cuenta 85-90 pasos en 30″ o usa el metrónomo del reloj.',
      'Nunca más de ~1,3× la media de tus últimas 4 semanas. La app te avisa.',
      'Semana 3: ~2,5 km en total, por debajo del techo de 3 km/sem para empezar con sobrepeso.',
      'Misma superficie y mismas zapatillas: no cambies las dos a la vez. Mejor asfalto liso o tierra que aceras.',
      'Molestia en espinilla o rodilla que empeora al correr: corta y camina. La que se va al calentar, vigílala.'
    ]
  };
  ...
  const EJERCICIOS = {
    ...
    'sentadilla-barra': { pat: 'rod',
      ...
      mol: 'Rodilla: baja en 3″ y quédate 5 cm por encima del punto molesto. Lumbar: revisa la presurización y baja el peso un 20% una semana.'
    },
    'prensa': { pat: 'rod',
  ...
  /* ---------- LAS 8 REGLAS ---------- */
  const REGLAS = [
    { n: 1, t: 'RPE controlado', d: 'Cada fase tiene su tope. Tu sistema nervioso recuerda; tus tendones llevan años sin cargar. Frena tú antes de que frenen ellos.' },
    { n: 2, t: 'Progresión doble', d: 'Primero repeticiones dentro del rango, luego peso: +2,5 kg (+5 en sentadilla y rumano), solo con técnica limpia en todas las series. La app te lo sugiere.' },
    { n: 3, t: 'Báscula = media semanal', d: 'Lunes, miércoles y viernes en ayunas, y mira solo la media. Un día suelto no dice nada: agua, sal, creatina.' },
    { n: 4, t: 'Proteína: {p} g en 4 tomas', d: 'Ninguna toma por debajo de {q} g. Decide si lo que cambia es grasa o músculo.' },
    { n: 5, t: '8.000–10.000 pasos diarios', d: 'Todos los días, entrenes o no. Queman más a la semana que las propias sesiones.' },
    { n: 6, t: 'Sueño 7–8 h: innegociable', d: 'Con 5,5 h de sueño en déficit pierdes un 55% menos de grasa y un 60% más de músculo. Cafeína solo antes de las 13-14 h.' },
    { n: 7, t: 'Un día fallado no se recupera', d: 'Ni dobles sesión ni recortes comida al día siguiente: sigue el calendario.' },
    { n: 8, t: 'Mínimo innegociable', d: 'Lo que mata es 3 meses a tope y 3 a cero. La semana caótica tiene un suelo: 2 fuerzas + 1 cardio.' }
  ];

  const SENALES = ['Para ese día: dolor punzante en rodilla, hombro o lumbar durante el movimiento; molestia que empeora serie a serie en vez de irse al calentar.', 'Normal: agujetas difusas a las 24-48 h.', 'Fisio antes de seguir: dolor articular localizado más de 5 días.'];

  /* ---------- NUTRICIÓN ---------- */
  const NUTRI = {
    calorias: [
      { c: 'Metabolismo basal', v: '~1.950 kcal', n: '95,1 kg · 183 cm · 30 años' },
      { c: 'Gasto total estimado', v: '2.850–3.000 kcal', n: 'Entrenos + 8-10k pasos' },
      { c: 'Ingesta objetivo', v: '2.250–2.400 kcal', n: 'Déficit ~550–700 kcal/día: más frena la recuperación de músculo.' },
      { c: 'Ritmo de pérdida esperado', v: '0,6–0,75 kg/sem', n: '≈0,7% del peso a la semana, el óptimo para retener músculo. Media semanal.' }
    ],
    fases: [
    ...
    escalado: 'La proteína ({p} g) no se toca: al subir el entreno solo sube el carbohidrato.',
    tomas: 'El total manda, pero repartirlo en 4 exprime la síntesis y quita el hambre de noche.',
    plato: [
      { t: 'Proteína (cada comida)', d: '200-250 g de pollo/pavo/pescado blanco en crudo, o 170-180 g de salmón/ternera, o 3 huevos + 2 claras, o 250 g de skyr + whey.' },
      { t: 'Carbohidrato', d: '60-75 g en crudo de arroz/pasta, o 250-300 g de patata, o 60 g de pan integral, o 50 g de avena.' },
    ...
    suplementos: [
      { id: 'creatina', t: 'Creatina monohidrato', d: '5 g al día, a cualquier hora, sin carga, desde ya. Retiene 1-2 kg de agua las primeras semanas: no es grasa. Fíate de la cintura y la media semanal; la gráfica lo marca.' },
      { id: 'whey', t: 'Whey', d: '1 cazo en la toma pre-sueño con el skyr (y otro donde haga falta los días cortos de proteína).' },
      { id: 'cafeina', t: 'Cafeína', d: 'Nada de cafeína después de las 13-14 h: 200 mg alteran el sueño hasta 13 h después; un café, ~9 h. Entreno de mañana: café 30-45′ antes. De tarde: sin cafeína; el pre-entreno es la merienda (fruta + skyr, 60-90′ antes).' },
      { id: 'vitamina-d', t: 'Vitamina D', d: 'Solo si la analítica sale por debajo de 30 ng/mL, probable con vida de interior.' },
      { id: 'omega-3', t: 'Omega-3', d: '~2 g de EPA+DHA al día: beneficio modesto pero real en fuerza y tendón.' },
      { id: 'no', t: 'No gastes en', d: 'Quemagrasas, BCAA/EAA (ya los cubre tu proteína) y «testo boosters». No mueven la aguja.' }
    ],
    hidratacion: 'Agua: 2,5–3 L al día. Alcohol: solo en la comida libre; suma calorías y frena la recuperación.',
    comidaLibre: 'Una comida a la semana, no un día (sábado por defecto). Come lo que te apetezca en cantidad normal, sin compensar antes ni después. Así el plan aguanta {s} semanas y una vida social. Se puede mover; sigue siendo una.'
  };
  ...
  const RECETAS = [
    {
      ...
      ing: [
        { pid: 'skyr', q: '250 g', i: 'skyr natural (o queso fresco batido 0%)' },
        { pid: 'avena', q: '50 g', i: 'copos de avena' },
        { pid: 'platano', q: '1 ud (120 g)', i: 'plátano' },
        { pid: 'nueces', q: '10 g', i: 'nueces' },
        { pid: 'canela', q: 'al gusto', i: 'canela' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        ...
        { pid: 'claras', q: '2 ud (o 100 ml envasadas)', i: 'claras' },
        { pid: 'pan', q: '60 g (2 rebanadas)', i: 'pan integral' },
        { pid: 'tomate', q: '100 g', i: 'tomate rallado' },
        { pid: 'aove', q: '5 g', i: 'AOVE' },
        { pid: 'sal', q: 'pizca', i: 'sal' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        { pid: 'pollo', q: '250 g crudo (~200 g hecho)', i: 'pechuga de pollo', n: 'batch: 1,2 kg = 5 raciones' },
        { pid: 'patata', q: '200 g', i: 'patata en gajos' }, { pid: 'pimiento', q: '50 g', i: 'pimiento' }, { pid: 'cebolla', q: '50 g', i: 'cebolla' },
        { pid: 'aove', q: '10 g', i: 'AOVE (parte del asado)' },
        { pid: 'especias', q: 'al gusto', i: 'pimentón, ajo en polvo, sal, orégano' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        { pid: 'lentejas', q: '250 g escurridas', i: 'lentejas cocidas de bote', n: 'batch: 2 botes = 3 raciones' },
        { pid: 'pollo', q: '120 g', i: 'pollo asado en tiras (del horneado)' },
        { pid: 'cebolla', q: '¼ ud', i: 'cebolla' },
        { pid: 'pimiento', q: '½ ud', i: 'pimiento' },
        { pid: 'zanahoria', q: '1 ud', i: 'zanahoria' },
        { pid: 'aove', q: '4 g', i: 'AOVE (parte del sofrito)' },
        { pid: 'especias', q: '1 cdta / ½ cdta', i: 'pimentón / comino' },
        { pid: 'caldo', q: '150 ml', i: 'caldo o agua' },
        { pid: 'fruta', q: '1 pieza', i: 'fruta de postre' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        { pid: 'ternera', q: '180-200 g', i: 'ternera magra en tiras' },
        { pid: 'arroz', q: '70 g crudo (≈ 180 g cocido)', i: 'arroz', n: 'usa el del batch' },
        { pid: 'verduras', q: '250 g', i: 'verdura variada: pimiento, cebolla, calabacín, zanahoria' },
        { pid: 'salsa-soja', q: '15 ml', i: 'salsa de soja' },
        { pid: 'aove', q: '8 g', i: 'AOVE' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        { pid: 'salmon', q: '170-180 g', i: 'lomo de salmón' },
        { pid: 'arroz', q: '75 g crudo (≈ 190 g cocido)', i: 'arroz', n: 'del batch' },
        { pid: 'brocoli', q: '200 g', i: 'brócoli' },
        { pid: 'limon', q: '½ ud', i: 'limón' },
        { pid: 'sal', q: 'pizca', i: 'sal' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        { pid: 'merluza', q: '250 g', i: 'merluza o lubina en lomos' },
        { pid: 'patata', q: '250 g', i: 'patata' },
        { pid: 'lechuga', q: '100 g', i: 'lechuga' }, { pid: 'tomate', q: '1 ud', i: 'tomate' }, { pid: 'cebolla', q: '¼ ud', i: 'cebolla' },
        { pid: 'aove', q: '10 g', i: 'AOVE (5 patata + 5 ensalada)' },
        { pid: 'skyr', q: '1 ud', i: 'skyr de postre' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        { pid: 'huevos', q: '3 ud', i: 'huevos M' },
        { pid: 'gambas', q: '150 g', i: 'gambas peladas (congeladas van perfectas)' },
        { pid: 'pan', q: '40 g', i: 'pan integral' },
        { pid: 'lechuga', q: 'bol', i: 'ensalada verde' },
        { pid: 'aove', q: '8 g', i: 'AOVE' },
        { pid: 'ajo', q: '1 diente', i: 'ajo' }
      ],
      pasos: [
    ...
    },
    {
      ...
      ing: [
        { pid: 'skyr', q: '250 g', i: 'skyr o queso fresco batido 0%' },
        { pid: 'whey', q: '1 cazo (30 g)', i: 'whey (el sabor que no te aburra)' },
        { pid: 'canela', q: 'al gusto', i: 'canela' }
      ],
      pasos: [
      ...
      tips: 'Remata la proteína del día y quita el hambre de noche, donde mueren las dietas. La caseína se digiere lenta: trabaja mientras duermes.'
    },
    {
      ...
      ing: [
        { pid: 'atun', q: '2 latas (120 g escurrido)', i: 'atún al natural' },
        { pid: 'huevos', q: '1 ud', i: 'huevo duro (del batch)' },
        { pid: 'patata', q: '150 g', i: 'patata cocida (del batch)' },
        { pid: 'tomate', q: '150 g', i: 'tomate' },
        { pid: 'aceitunas', q: '30 g', i: 'aceitunas' },
        { pid: 'cebolla', q: '¼ ud', i: 'cebolla morada' },
        { pid: 'aove', q: '10 g', i: 'AOVE' }
      ],
      pasos: [
    ...
    { id: 'porridge-soja', slot: 'de', tags: [], nombre: 'Porridge de avena y proteína', tipo: 'Desayuno C', tiempo: '8′', cocina: 'Cazo o micro',
      ...
      ing: [{ pid: 'avena', q: '70 g', i: 'copos de avena (certificada sin gluten)' }, { pid: 'bebida-soja', q: '250 ml', i: 'bebida de soja sin azúcar' }, { pid: 'prote-vegetal', q: '25 g', i: 'proteína de guisante, sabor neutro o vainilla' }, { pid: 'platano', q: '1', i: 'plátano en rodajas' }, { pid: 'canela', q: 'al gusto', i: 'canela' }],
    ...
    { id: 'tofu-revuelto', slot: 'de', tags: [], nombre: 'Tofu revuelto con tostadas', tipo: 'Desayuno D', tiempo: '12′', cocina: 'Sartén',
      ...
      ing: [{ pid: 'tofu', q: '200 g', i: 'tofu firme desmenuzado' }, { pid: 'pan-sg', q: '2 rebanadas (70 g)', i: 'pan sin gluten' }, { pid: 'levadura', q: '10 g', i: 'levadura nutricional' }, { pid: 'tomate', q: '1', i: 'tomate en rodajas' }, { pid: 'aove', q: '5 g', i: 'AOVE' }, { pid: 'especias', q: 'al gusto', i: 'cúrcuma, sal negra kala namak, pimienta' }],
    ...
    { id: 'bol-soja-frutos', slot: 'de', tags: [], nombre: 'Bol de yogur de soja y frutos rojos', tipo: 'Desayuno E', tiempo: '5′', cocina: 'Sin cocina',
      ...
      ing: [{ pid: 'yogur-soja', q: '250 g', i: 'yogur de soja natural sin azúcar' }, { pid: 'prote-vegetal', q: '20 g', i: 'proteína vegetal en polvo' }, { pid: 'frutos-rojos', q: '120 g', i: 'frutos rojos (congelados valen)' }, { pid: 'chia', q: '15 g', i: 'semillas de chía' }, { pid: 'platano', q: '1', i: 'plátano pequeño' }],
    ...
    { id: 'revuelto-espinacas', slot: 'de', tags: ['huevo'], nombre: 'Revuelto de huevos con espinacas', tipo: 'Desayuno F', tiempo: '10′', cocina: 'Sartén',
      ...
      ing: [{ pid: 'huevos', q: '3', i: 'huevos' }, { pid: 'espinacas', q: '100 g', i: 'espinacas frescas' }, { pid: 'champinones', q: '100 g', i: 'champiñones laminados' }, { pid: 'pan-sg', q: '50 g', i: 'pan sin gluten' }, { pid: 'aove', q: '5 g', i: 'AOVE' }, { pid: 'fruta', q: '150 g', i: 'fruta de temporada' }],
    ...
    { id: 'curry-lentejas', slot: 'co', tags: [], nombre: 'Curry de lentejas rojas con arroz', tipo: 'Comida · batch domingo', tiempo: '25′ olla', cocina: 'Olla',
      ...
      ing: [{ pid: 'lentejas-rojas', q: '100 g', i: 'lentejas rojas secas' }, { pid: 'leche-coco', q: '100 ml', i: 'leche de coco ligera' }, { pid: 'tomate-triturado', q: '150 g', i: 'tomate triturado' }, { pid: 'arroz', q: '50 g', i: 'arroz basmati seco' }, { pid: 'aove', q: '10 g', i: 'AOVE' }, { pid: 'especias', q: 'al gusto', i: 'cebolla, ajo, jengibre, curry en polvo, sal' }],
    ...
    { id: 'tofu-salteado', slot: 'co', tags: [], nombre: 'Tofu salteado con verduras y arroz integral', tipo: 'Comida · 20′', tiempo: '20′', cocina: 'Wok / sartén',
      ...
      ing: [{ pid: 'tofu', q: '200 g', i: 'tofu firme en dados' }, { pid: 'arroz', q: '70 g', i: 'arroz integral seco' }, { pid: 'brocoli', q: '100 g', i: 'brócoli' }, { pid: 'pimiento', q: '75 g', i: 'pimiento' }, { pid: 'zanahoria', q: '75 g', i: 'zanahoria' }, { pid: 'tamari', q: '15 ml', i: 'tamari (salsa de soja sin gluten)' }, { pid: 'aove', q: '10 g', i: 'AOVE' }, { pid: 'sesamo', q: '10 g', i: 'semillas de sésamo' }],
    ...
    { id: 'bol-garbanzos', slot: 'co', tags: [], nombre: 'Bol de garbanzos asados con quinoa y hummus', tipo: 'Comida · 15′ fresco', tiempo: '15′ (+ horno)', cocina: 'Horno + sin fuego',
      ...
      ing: [{ pid: 'garbanzos', q: '200 g', i: 'garbanzos cocidos' }, { pid: 'quinoa', q: '60 g', i: 'quinoa seca' }, { pid: 'hummus', q: '50 g', i: 'hummus' }, { pid: 'pimiento', q: '100 g', i: 'pimiento' }, { pid: 'pepino', q: '50 g', i: 'pepino' }, { pid: 'aove', q: '5 g', i: 'AOVE' }, { pid: 'especias', q: 'al gusto', i: 'comino, pimentón, limón, sal' }],
    ...
    { id: 'pasta-lentejas-tempeh', slot: 'co', tags: [], nombre: 'Pasta de lentejas con tempeh al tomate', tipo: 'Comida · 20′', tiempo: '20′', cocina: 'Olla + sartén',
      ...
      ing: [{ pid: 'pasta-lentejas', q: '80 g', i: 'pasta de lentejas rojas (sin gluten)' }, { pid: 'tempeh', q: '120 g', i: 'tempeh en dados' }, { pid: 'tomate-triturado', q: '200 g', i: 'tomate triturado' }, { pid: 'cebolla', q: '80 g', i: 'cebolla' }, { pid: 'ajo', q: '1 diente', i: 'ajo' }, { pid: 'aove', q: '10 g', i: 'AOVE' }, { pid: 'especias', q: 'al gusto', i: 'albahaca, orégano, sal' }],
    ...
    { id: 'tortilla-garbanzo', slot: 'ce', tags: [], nombre: 'Tortilla de harina de garbanzo con calabacín', tipo: 'Cena · 20′', tiempo: '20′', cocina: 'Sartén',
      ...
      ing: [{ pid: 'harina-garbanzo', q: '80 g', i: 'harina de garbanzo (sin gluten)' }, { pid: 'calabacin', q: '200 g', i: 'calabacín en láminas finas' }, { pid: 'cebolla', q: '80 g', i: 'cebolla' }, { pid: 'aove', q: '10 g', i: 'AOVE' }, { pid: 'lechuga', q: '100 g', i: 'ensalada verde' }, { pid: 'especias', q: 'al gusto', i: 'sal, pimienta, cúrcuma' }],
    ...
    { id: 'crema-calabaza-tofu', slot: 'ce', tags: [], nombre: 'Crema de calabaza con edamame y tofu a la plancha', tipo: 'Cena · 25′', tiempo: '25′', cocina: 'Olla + plancha',
      ...
      ing: [{ pid: 'calabaza', q: '300 g', i: 'calabaza en dados' }, { pid: 'edamame', q: '100 g', i: 'edamame desgranado (congelado)' }, { pid: 'tofu', q: '150 g', i: 'tofu firme en filetes' }, { pid: 'cebolla', q: '60 g', i: 'cebolla' }, { pid: 'aove', q: '10 g', i: 'AOVE' }, { pid: 'pipas', q: '10 g', i: 'pipas de calabaza' }],
    ...
    { id: 'ensalada-quinoa-alubias', slot: 'ce', tags: [], nombre: 'Ensalada templada de quinoa, alubias negras y aguacate', tipo: 'Cena · 15′', tiempo: '15′', cocina: 'Olla + sin fuego',
      ...
      ing: [{ pid: 'quinoa', q: '40 g', i: 'quinoa seca' }, { pid: 'alubias', q: '200 g', i: 'alubias negras cocidas' }, { pid: 'aguacate', q: '80 g', i: 'aguacate' }, { pid: 'tomate', q: '100 g', i: 'tomate' }, { pid: 'cebolla', q: '20 g', i: 'cebolla morada' }, { pid: 'cilantro', q: 'al gusto', i: 'cilantro' }, { pid: 'aove', q: '5 g', i: 'AOVE' }, { pid: 'especias', q: 'al gusto', i: 'lima, comino, sal' }],
    ...
    { id: 'bolonesa-soja', slot: 'ce', tags: [], nombre: 'Boloñesa de soja texturizada con calabacín en espiral', tipo: 'Cena · 20′', tiempo: '20′', cocina: 'Sartén',
      ...
      ing: [{ pid: 'soja-text', q: '60 g', i: 'soja texturizada fina (seca)' }, { pid: 'tomate-triturado', q: '250 g', i: 'tomate triturado' }, { pid: 'calabacin', q: '300 g', i: 'calabacín en espirales o tiras' }, { pid: 'cebolla', q: '50 g', i: 'cebolla' }, { pid: 'zanahoria', q: '40 g', i: 'zanahoria' }, { pid: 'ajo', q: '1 diente', i: 'ajo' }, { pid: 'aove', q: '10 g', i: 'AOVE' }, { pid: 'especias', q: 'al gusto', i: 'orégano, pimentón, sal' }],
  ...
  const CIENCIA = {
    intro: 'Plan revisado contra la evidencia (metaanálisis y ensayos 2010-2025). La idea que lo ordena todo: quien vuelve no es un novato. Músculo y sistema nervioso regresan rápido; el tendón no tiene memoria y marca el ritmo.',
    temas: [
      { t: 'Memoria muscular', d: 'Recuperar lo ganado es real y rápido: fuerza en ~8 semanas, tamaño en ~12. El mecanismo se debate; el efecto no. Por eso la doble progresión puede ir más rápido que en un novato, y por eso mismo no se comprime el calendario: el tendón no corre.', ref: 'Rahmati 2022 (metaanálisis, J Cachexia Sarcopenia Muscle) · Cumming 2024 (J Physiol)' },
      { t: 'Tendón: el limitante', d: 'El colágeno del tendón se renueva ~10× más lento que el músculo. Lo adaptan cargas altas con contracciones lentas de ~3″ (HSR) e isométricos al 70% (5×45″), que además quitan dolor al momento. Los saltos son mal estímulo: nada de pliometría para «preparar» el trote.', ref: 'Mersmann 2017 (Front Physiol) · Rio 2015 (BJSM) · Kongsgaard (HSR)' },
      ...
      { t: 'Diet break', d: 'Alternar déficit con descansos a mantenimiento atenuó la caída metabólica y mejoró la pérdida de grasa (estudio MATADOR). En {s} semanas su valor es otro: te enseña que parar una semana con plan no es recaer.', ref: 'Byrne 2018 (Int J Obesity, MATADOR)' },
      { t: 'Volumen justo', d: 'Más series, más músculo, con rendimientos decrecientes; en déficit el exceso solo suma fatiga y riesgo. Diana: ~10 series por músculo y semana en F2, 12-18 en F3-F4. El mínimo (2 fuerzas + 1 cardio) conserva músculo de verdad.', ref: 'Pelland 2025 (Sports Medicine) · Androulakis-Korakakis 2020 (dosis mínima)' },
      { t: 'Descarga bien hecha', d: 'Parar del todo una semana cuesta fuerza; lo que funciona es la mitad de volumen con el mismo peso. Por eso la descarga es obligatoria y de ese tipo.', ref: 'Coleman 2024 (PeerJ, ECA de descarga)' },
      { t: 'Sueño', d: 'Dormir 5,5 h en déficit (frente a 8,5) redujo la grasa perdida un 55% y multiplicó la pérdida de músculo. Tras proteína y déficit, es tu mayor palanca. De ahí el corte de cafeína a las 13-14 h.', ref: 'Nedeltcheva 2010 (Ann Intern Med) · Gardiner 2023 (Sleep Med Rev)' },
      { t: 'Salud primero', d: 'Tras años parado, antes del trabajo fuerte de F3-F4: tensión arterial y analítica básica (lípidos, glucosa/HbA1c). Con cualquier síntoma, médico antes de seguir.', ref: 'ACSM Preparticipation Health Screening' }
    ]
  };


  const AVISO_LEGAL = 'El plan sale de tus respuestas con fórmulas estándar (Mifflin-St Jeor y factores de actividad) y un margen de ±10% que las reglas de ajuste corrigen con tus datos. No sustituye consejo médico: ante patología, dolor persistente o duda, consulta a un profesional sanitario.';
  ...
  const UI = {
    ...
    pLeyenda: ['pesajes', 'media semanal', 'corredor'],
    platoLbl: { v: 'Verdura', p: 'Proteína', c: 'Carbohidrato', g: 'Aceite', mano: 'palma y media', puno: 'un puño', cuchara: 'una cucharada' },
    nExtra: ['—', '+1 fruta y 40 g de pan los días de entreno', 'igual, todos los días'],
    lang: 'es',
    tabs: ['Hoy', 'Plan', 'Ejercicios', 'Comida', 'Progreso', 'Logros'],
    dias: ['lunes', 'martes', 'miércoles', 'jueves', 'viernes', 'sábado', 'domingo'],
    diasIni: ['L', 'M', 'X', 'J', 'V', 'S', 'D'],
    calComidas: 'Comidas del día',
    ...
    preplanSub: '{f} · Fase 1 en casa. Mientras tanto, la línea base:',
    prepCintura: 'Cintura en ayunas',
    prepFotos: 'Fotos día 0: frente y perfil, misma luz siempre',
    prepCompra: 'Compra de la semana 1 (lista en Comida)',
    prepBascula: 'Báscula: lunes, miércoles y viernes en ayunas, siempre igual',
    practicaMenu: 'El menú ya vale desde hoy; el {f} va en serio.',
    descanso: 'Descanso', domingoPrep: 'Domingo: descanso + meal prep', planCompletado: 'Plan completado',
    calentamiento: 'Calentamiento · 6′',
    sesionSub: '{d} · toca un descanso para cronometrarlo',
    ...
    hPeso: 'Peso en ayunas', hPesoSub: 'Cuenta la media semanal',
    hCintura: 'Cintura (lunes)', hCinturaSub: 'La métrica reina',
    ...
    quizAfinara: 'Esto afinará tu plan.', quizTitulo: 'Tus gustos',
    quizSi: 'Me gusta', quizNo: 'No me va', quizDeshacer: 'Deshacer', quizSaltar: 'Saltar',
    quizListo: 'Listo',
    gen: { kcalHueco: 'Ajusta el arroz, la pasta o el pan de la comida principal para cubrir la diferencia.', kcalSube: 'te faltan ~{d}', kcalBaja: 'te sobran ~{d}', chkDentro: 'dentro', chkBajo: 'por debajo', chkAlto: 'por encima', lChkD2: 'Peso dentro del corredor en la semana {s}.', tHombroT: 'Hombro · manguito y serrato', tHombroD: 'Rotación externa con banda 2×15 por lado y elevación en Y tumbado 2×12, lentas, antes de cualquier empuje y en días sueltos. El manguito gana con control, no con peso.', tHombroW: 'En casa con banda, o con la mancuerna más ligera que tengas.', r2SinBarra: 'Primero repeticiones dentro del rango, luego carga: el salto más pequeño que tengas (una mancuerna más, una banda más dura, una variante más difícil), solo con técnica limpia en todas las series. La app te lo sugiere.', protHueco: 'Hasta tus {p} g de proteína, el puente es una toma extra: batido o una ración más.', finRecapT: 'Tu bloque, en números', subCorporal: 'Al peso corporal: llega limpio al tope de repeticiones y sube de variante.', subRepe: 'Segunda vuelta: sin material no hay treinta variantes, y repetir el patrón con técnica limpia sigue construyendo.', f2nCasa: 'Entrada en carga', f2oCasa: 'Básicos con mancuernas y bandas, y base de carga: 65-70% de lo que podrías, 3 repeticiones reales en reserva.', f2nNada: 'Progresión corporal', f2oNada: 'Progresiones con tu cuerpo y base. Primero palanca, luego repeticiones: variante más difícil solo con técnica limpia.', gemNota: 'El gemelo lento es el seguro del tendón: no lo saltes.', tendonSinTrote: 'La fuerza vuelve en semanas; el tendón necesita meses: su colágeno se renueva ~10 veces más lento y no tiene memoria. Este bloque es el seguro del plan, de la semana 1 a la última.', introNunca: 'Plan revisado contra la evidencia (metaanálisis y ensayos 2010-2025). La idea que lo ordena todo: de cero se progresa rápido (los primeros meses son los de más ganancia de fuerza de tu vida), pero el tejido conectivo va detrás del músculo. Por eso las cargas suben despacio aunque puedas más.', introActivo: 'Plan revisado contra la evidencia (metaanálisis y ensayos 2010-2025). La idea que lo ordena todo: quien ya entrena no necesita más caña, sino mejor dosis. Volumen justo, progresión registrada y descanso contado separan mantenerse de mejorar.', cNuncaT: 'Empezar de cero', cNuncaD: 'El primer año es el de mayor ganancia de fuerza de la vida: casi cualquier dosis bien hecha funciona, por eso sobran los programas extremos. La técnica va primero: las repeticiones limpias de hoy son los kilos seguros de dentro de tres meses.', cNuncaR: 'ganancias de novato: revisiones ACSM y metaanálisis de dosis-respuesta', cActivoT: 'Añadir sin romperte', cActivoD: 'El riesgo de quien ya entrena es apilar volumen nuevo sobre el viejo. Los saltos por encima de ~1,3× tu carga media reciente disparan las lesiones: añade una variable cada vez (días, volumen o intensidad), nunca las tres.', cActivoR: 'consenso COI de carga de entrenamiento (ACWR)', cSupT: 'Superávit que construye', cSupD: 'Para ganar músculo basta un superávit pequeño (~250-350 kcal): por encima, el extra se reparte hacia grasa. La báscula debe subir despacio; si sube rápido, no es músculo, porque la síntesis proteica tiene techo semanal.', cSupR: 'Garthe 2013 · Slater 2019 (superávit y composición)', r1Nunca: 'Cada fase tiene su tope. De cero, la fuerza sube más rápido que la resistencia de tus tejidos: deja 2-3 repeticiones reales en reserva y las ganancias llegan igual.', r1Activo: 'Cada fase tiene su tope. Este volumen es nuevo aunque entrenes: respeta el RPE las dos primeras semanas y sube después. Frenar a tiempo es lo que te deja progresar {s} semanas seguidas.', r8Nunca: 'Al principio el enemigo no es la dureza, es la irregularidad. Suelo de la semana caótica: 2 fuerzas + 1 cardio.', r8Activo: 'Quien entrena también tiene semanas imposibles. Suelo: 2 fuerzas + 1 cardio. No se pierde nada; el resto se recupera.', f1nNunca: 'Cimientos', f1oNunca: 'Hábito y patrones de movimiento, sin castigar articulaciones. Quedarte con ganas es intencionado.', f2nNunca: 'Técnica', f2oNunca: 'Básicos con carga ligera: cada repetición limpia ahora son kilos seguros después. Siempre lejos del fallo.', f3oNunca: 'Volumen e intensidad de verdad, con la técnica rodada. Termina cada serie con 2 repeticiones reales en reserva.', f1nActivo: 'Base', f1oActivo: 'Dos semanas de adaptación: dosis conocida, registro en marcha, técnica afinada. Luego se sube.', f2nActivo: 'Construcción', f2oActivo: 'Volumen progresivo sobre tu base: 70-75% de lo que podrías, 2-3 repeticiones reales en reserva.', f3oActivo: 'Volumen e intensidad reales para forzar el cambio. Termina cada serie con 2 repeticiones reales en reserva.', cierrePerder: 'El objetivo no es el {f}: es llegar entrenando por costumbre, sin ciclo on/off. El peso que baja es la consecuencia.', cierreRecomp: 'El objetivo no es el {f}: es llegar con el hábito hecho y la ropa sentando distinto. Recomponer es lento por diseño; la constancia es la meta.', cierreGanar: 'El objetivo no es el {f}: es llegar más fuerte y con el hábito hecho. El músculo se construye en meses: el siguiente bloque empieza donde acaba este.', cierreManten: 'El objetivo no es el {f}: es que entrenar deje de ser un plan y sea costumbre. Mantener es ganar.', cierreRenueva: 'Para renovar el bloque: Ajustes › Crear / rehacer mi plan.', platoVegetariano: '3 huevos + 2 claras, o 250 g de skyr o queso fresco batido + whey, o 200 g de tofu firme, o 150 g de tempeh, o 250 g de legumbre cocida + 1 huevo.', platoVegano: '200-250 g de tofu firme, o 150-180 g de tempeh, o 250 g de legumbre cocida + un cazo de proteína vegetal, o 80 g (en seco) de soja texturizada.', suplVegT: 'Proteína vegetal', suplVegD: '1 cazo de proteína de guisante o soja en la toma pre-sueño, y otro los días cortos de proteína.', numRecomp: 'Déficit suave, ~300-450 kcal/día: recomponer pide paciencia.', numSup: 'Superávit ~250-350 kcal/día: más no es más músculo, es grasa.', numMan: 'Tu mantenimiento estimado: la media semanal juzga y ajusta.', ritmoSubeT: 'Ritmo de subida esperado', ritmoManT: 'Ritmo esperado', ritmoSubeN: '≈0,25% del peso a la semana: lo que el músculo puede construir. Media semanal.', ritmoManN: 'La media semanal debe quedarse a ±0,3 kg de tu salida.', wjN1: 'Caminar-trotar I', wjN2: 'Caminar-trotar II', wjN3: 'Caminar-trotar III', lChkN: 'Checkpoint S{s}', lChkD: 'Peso dentro o mejor del corredor en la semana {s}.', alRapidoBaja: 'Añade 150 kcal de carbohidrato. A este ritmo el déficit también se come músculo.', alLentoBaja: 'Repasa raciones y pasos un par de días. Si sigue plano, quita 100 kcal de carbohidrato solo los días de descanso.', alRapidoSube: 'Subes más rápido de lo que se construye músculo: recorta 150 kcal de carbohidrato o el extra será grasa.', alLentoSube: 'El superávit no asoma en la báscula: añade 150 kcal de carbohidrato en días de entreno.', alMantenT: 'Te estás moviendo del mantenimiento', alMantenD: 'Dos semanas seguidas de deriva: ajusta 100-150 kcal en la dirección contraria y no toques el entreno.', circProg: 'Sube 1-2 repeticiones por semana donde llegues con técnica limpia: esa es la progresión.', durAprox: '≈{m}′', splitFbC: 'Full Body', splitTpC: 'Torso · Pierna', splitPplC: 'Push · Pull · Legs', faseSub: '{s} ×{d}', nf1: 'F1–F2 (sem 1-{a})', nf2: 'F3 (sem {b}-{c})', nf3: 'F4 (sem {d}-{e})', dietBreakNota: 'Semana {w}: diet break a ~{k} kcal', hitoCribadoT: 'Cribado de salud', hitoCribadoD: 'Antes de cargar de verdad, si llevas años parado: tensión en una farmacia y analítica básica (lípidos, glucosa). 15 minutos.', hitoDietT: 'Diet break', hitoDietD: 'Semana a mantenimiento, ~{k} kcal: +2 raciones de carbohidrato al día. Proteína y entreno igual. El lunes siguiente, déficit otra vez.', hitoDescargaT: 'Descarga · obligatoria', hitoDescargaD: 'Misma rutina, la mitad de series, misma carga. No es parar: descansan tendones y articulaciones sin perder tejido.', tomaNocheAlt: '+ cada noche: toma pre-sueño con proteína vegetal, ~40 g en batido. ', franjaM: 'Entreno de mañana: desayuna después, no antes.', franjaMd: 'Entreno a mediodía: la comida fuerte va justo después.', franjaT: 'Entreno de tarde: algo ligero antes; la cena es el post-entreno.', cardioLibreT: 'Cardio: {d}', cardioLibreD: '{m}′ a ritmo cómodo y constante. Tu deporte cuenta igual que el trote.', chk1: 'Fuera del corredor: repasa raciones y pasos antes de tocar nada. Al principio también se mueve agua.', chk2: 'Dos semanas fuera: ajusta 150 kcal de carbohidrato en la dirección que toque. La proteína no se toca.', chk3: 'Cierre: fotos, medidas y el siguiente bloque, decidido con datos.', lKgN: '−{v} kg', lKgD: 'Media semanal {v} kg por debajo de la salida.', lKgUpN: '+{v} kg', lKgUpD: 'Media semanal {v} kg por encima de la salida. Músculo, ladrillo a ladrillo.', lCintN: 'Cintura −{v}', lCintD: 'Cintura por debajo de {v} cm.', lReinaN: 'Métrica reina', lReinaD: 'Cintura por debajo de la mitad de tu estatura: {v} cm.', lFinDesc: 'Plan de {s} semanas terminado. La meta era el hábito; lo demás es consecuencia.', marca: 'Plan generado a tu medida', cuida: 'cuida: {a}', datos: '{p} kg · {a} cm · {e} años', menuAviso: '{n} platos no encajan con tu dieta: cámbialos por otro del recetario, ya filtrado.', prepNota: 'Solo lo marcado «batch» se cocina el domingo; el resto, al momento. La compra ya cuenta las repeticiones de la semana.' },
    pBarraT: 'La barra del plan', pBarraSub: '{a} de {b} discos cargados',
    patrones: { eh: 'Empuje horizontal', ev: 'Empuje vertical', th: 'Tracción horizontal', tv: 'Tracción vertical', rod: 'Dominante de rodilla', bis: 'Bisagra de cadera', zan: 'Zancada', core: 'Core estable', flex: 'Flexión de tronco', curl: 'Flexión de codo', ext: 'Extensión de codo', gem: 'Gemelo', ais: 'Aislamiento' },
    quizCatEj: 'Ejercicio', quizCatDep: 'Deporte', quizCatCom: 'Comida',
    alta: { t: 'Crea tu usuario', sub: 'Vuelve a tu mejor versión. Tu plan de entreno y nutrición.', nombreL: 'Tu nombre', ph: '¿Cómo te llamamos?', cta: 'Empezar', local: 'Tus datos viven solo en este dispositivo.', valNombre: 'Escribe un nombre de 2 a 24 letras.', idioma: 'Idioma' },
    rev: { evFecha: 'termina el {b}, justo antes', evSinFecha: 'sin fecha: manda el plazo que elegiste', minT: '{v} minutos por sesión', minSub: 'sesiones cortas: los básicos se quedan', evT: 'Objetivo: {e}', evSub: 'la fecha manda: constancia antes que perfección', durOpen: 'Sin fecha: bloques de {s} semanas, renovables', t: '{n}, tu plan está listo', tAnon: 'Tu plan está listo', sub: 'Hecho con tus respuestas, no una plantilla.',
      ...
      kcalT: '{k} kcal al día', kDef: 'déficit de {v} kcal, sin regalar músculo', kSup: 'superávit de {v} kcal para construir músculo', kMan: 'en tu mantenimiento, con la proteína al mando',
      ...
      menuT: 'Menú ajustado a tu mesa', menuSub: 'dieta e intolerancias aplicadas a la semana entera', menuAv: '{n} platos no encajan: avisado en Comida',
    ...
    tour: { salta: 'Saltar', sigue: 'Siguiente', listo: 'A entrenar', otraVez: 'Repetir el tour de bienvenida',
      antes: ['Tu plan está en marcha', 'Hasta el día que elegiste, Hoy te enseña los pasos previos. El menú ya está listo: ve comprando.'],
      pasos: [
      ['Esto es HOY', 'Tu sesión de hoy: ejercicios, series y descansos. Toca uno y verás técnica y músculo.'],
      ['La comida de hoy', 'Desayuno, comida, cena y toma de noche, para tu objetivo. Toca un plato: receta entera.'],
      ['Tu registro diario', 'Peso, cintura y hábitos: un toque cada uno. Cierra el día con el botón de abajo.'],
      ['El plan entero', 'Cada fase con su color. Toca un día: su entreno y sus comidas. Desliza para cambiar de mes.'],
      ['Las cuatro fases', 'Cada banda dice sus semanas y su intensidad. Despliégala: qué persigue.'],
      ['Tu biblioteca de ejercicios', 'Todos los movimientos por zona: músculo pintado, técnica y qué usar si falta material.'],
      ['Tu objetivo en la mesa', 'Calorías y macros de la fase, y cuánto le falta o sobra al menú. El porqué, en Mi perfil.'],
      ['Recetario', 'Desayunos, comidas, cenas y suplementos filtrados para ti, con foto, ingredientes y pasos.'],
      ['La compra de la semana', 'Todo lo de la semana por sección del súper, con la foto de cada producto. Marca lo que ya tienes.'],
      ['Progreso honesto', 'Peso, cintura, cargas y constancia, en gráficas. Si vas demasiado rápido, la app te frena.'],
      ['Tus insignias', 'Se ganan con constancia, no con intensidad. Cada una dice cómo se consigue.'],
      ['Dos burbujas', 'La lupa busca ejercicios, platos y ajustes. El bocadillo es para contarme fallos o ideas.'],
      ['Mi perfil', 'Tus respuestas, rehacer el plan, compartirlo, exportar datos, privacidad y borrar cuenta.'] ] },
    cuest: {
      evFechaT: '¿Qué día es?', evFechaP: 'El plan termina justo antes. Sin fecha, manda el plazo.', evFechaSaltar: 'No lo sé todavía', evFechaMal: 'Elige una fecha entre 2 y 12 meses desde hoy.', 
      ...
      gateT: 'Tu salud manda', gateTxt: 'Marcaste una condición médica que limita el ejercicio. Antes de generar el plan, pide a tu médico el visto bueno para fuerza {d} días por semana.',
      gateGuardado: 'Tus respuestas quedan guardadas.', gateOk: 'Tengo el visto bueno', gateSalir: 'Salir por ahora',
      gateHoyT: 'En pausa, con motivo', gateHoyTxt: 'Falta el visto bueno de tu médico. Con él, el plan se genera al momento.', gateVolver: 'Retomar el cuestionario',
      resCta: 'Generar mi plan', resGen: 'Generando tu plan…',
      titulo: 'Tu plan, a medida', atras: 'Atrás', sigue: 'Continuar',
      inicioT: '¿Cuándo quieres empezar?', inicioP: 'El plan se monta desde ese día.', inicioHoy: 'Hoy', inicioSemana: 'Esta semana', inicioLunes: 'El lunes que viene', inicioExacto: 'Un día concreto', inicioSemT: '¿Qué día de esta semana?', inicioDiaT: '¿Qué día quieres empezar?', sexoT: 'Tu cuerpo', sexoP: 'Solo para calcular tus calorías.', sexoH: 'Hombre', sexoM: 'Mujer', sexoX: 'Prefiero no decirlo',
      ...
      histT: '¿De dónde vienes?', histP: 'Cambia cómo arranca el plan.', histNunca: 'Nunca he entrenado', histRetoma: 'Vuelvo tras años sin entrenar', histActivo: 'Entreno ahora',
      ...
      resT: 'Tu perfil está listo', resP: 'Con esto se genera tu plan.',
      resGustos: '{a} me gusta · {b} descartes', resProfesional: 'Alguna respuesta pide consultar antes con un profesional sanitario.',
    ...
    sigueEditando: 'Se guarda solo; puedes seguir editando.',
    ...
    secCompra: { fresco: 'Frescos', prote: 'Proteína', lacteo: 'Lácteos y bebidas', despensa: 'Despensa', congelado: 'Congelados', supl: 'Suplementos' }, despensaTag: 'despensa',
    ...
    extraChip: 'Extra F{f}: +1 fruta y 40 g de pan en la comida.', sugRepite: '↻ repite {v}',
    ...
    fHistorial: 'Tu historial', fMejor: 'mejor {v} kg',
    fComo: 'Cómo se hace', fErrores: 'Errores típicos', fAlt: 'Alternativas',
    fVideo: 'Ver técnica en vídeo',
    fDomiBtn: 'Hoy salió mi primera dominada sin ayuda', fDomiOk: 'Registrada', fDomiYa: 'Dominada libre ya registrada',
    ...
    fase: 'Fase', sem: 'Sem', fuerzaLbl: 'Fuerza',
    zonas: { empuje: 'Empuje', tiron: 'Tracción', pierna: 'Pierna y cadera', core: 'Core' },
    ...
    nRecetario: 'Recetario', nToca: 'toca para cocinar',
    nCompra: 'La compra de la semana', nPrepDom: 'Meal prep del domingo', nSupl: 'Suplementos',
    nReiniciar: 'reiniciar', nProteLbl: 'Prote', nGrasaLbl: 'Grasa', nCarbosLbl: 'Carbos', kcalLbl: 'kcal', nMenuLbl: 'menú',
    ...
    pCargas: 'Cargas', pCargasSub: 'kg por sesión',
    pAdhTitulo: 'Adherencia', pAdhSub: 'fuerzas completadas por semana',
    pChk: 'Checkpoints', pEsperado: 'Esperado', pReal: 'Real', pSiDesvias: 'Si te desvías',
    pTabla: 'tabla', pGrafica: 'gráfica', pFecha: 'Fecha',
    pLifts: { 'press-banca': 'Banca', 'sentadilla-barra': 'Sentadilla', 'rdl-barra': 'Rumano' }, pMeta91: 'meta {m}', pAguaCreatina: 'agua (primeras semanas)', pLineaBase: 'Línea base',
    pMediaSemana: 'Media S{w}',
    pVacioPeso: 'Aquí irán tus pesajes de lunes, miércoles y viernes.',
    pVacioCintura: 'Cada lunes en ayunas',
    pVacioCargas: 'Registra kg en este ejercicio y aquí verás la escalada.',
    ...
    pRapido: 'Vas demasiado rápido', pLento: 'Vas más lento de lo esperado',
    pFrenaTrote: 'Frena el trote', pFrenaTxt: 'Esta semana corres {r}× tu media reciente. Por encima de 1,3× se dispara el riesgo de lesión: recorta o camina.',
    ...
    perfilCinturaAdd: '+ Añadir cintura', perfilCinturaNota: 'Será tu línea base y activa la meta y los logros de cintura. El plan no cambia.', cerrarSesion: 'Cerrar sesión', cerrarSesionNota: 'Tu plan y tus registros se quedan en este dispositivo.', rehacerSub: '¿Qué quieres rehacer?', rehacerTodo: 'Cuestionario completo', rehacerTodoSub: 'Datos y gustos, de arriba abajo.', rehacerDatos: 'Solo mis datos', rehacerDatosSub: 'Edad, objetivo, días, material… El mazo no se toca.', rehacerGustos: 'Solo mis gustos', rehacerGustosSub: 'El mazo de cartas, desde cero.', perfilDetrasT: 'Detrás del plan', buscarT: 'Buscar en la app', buscarPH: 'Ejercicio, plato, sección…', buscarNada: 'Nada con ese nombre. Prueba otra palabra.', perfilT: 'Mi perfil', perfilDatosT: 'Tus respuestas', perfilPlanT: 'Tu plan, en corto', ajustes: 'Ajustes', ajustesSub: 'Tus datos viven solo en este dispositivo.', ajGuardar: 'Guardar línea base', ajGuardado: 'Guardado',
    ajCopia: 'Copia de seguridad',
    ajCopiaTxt: 'Los datos no salen del móvil. Haz una copia de vez en cuando, o antes de cambiar de dispositivo.',
    ...
    ajRehacer: 'Crear / rehacer mi plan', ajRehacerNota: 'Vuelves al cuestionario. Tus registros diarios no se tocan.', ajBorrar: 'Eliminar perfil y todos los datos', ajBorrarConfirma: '¿Seguro? Toca otra vez para borrarlo todo',
    celebraOk: 'Seguimos',
    navAria: 'Navegación principal',
    pPrivacidad: 'Política de privacidad',
    rep: { t: 'Reportar', sub: '¿Falla algo o tienes una idea? Cuéntamelo.', bug: 'Falla algo', idea: 'Una idea', otro: 'Otra cosa', txtL: 'Cuéntamelo', ph: '¿Qué pasó? Di en qué pantalla y qué esperabas.', enviar: 'Enviar', gracias: 'Recibido, gracias.', corto: 'Escribe algo más para que se pueda entender.', repRitmo: 'Espera un minuto antes de enviar otro.', errRed: 'No se pudo enviar: revisa la conexión.', adjunta: 'Se adjunta versión, plataforma, idioma y pantalla. Nada de tu plan ni tus registros.' },
    nube: { correoL: 'Correo', claveL: 'Contraseña (mínimo 8)', verClave: 'Mostrar contraseña', ocultarClave: 'Ocultar contraseña', previoT: 'Plan anterior en este dispositivo', previoTxt: 'Este dispositivo guarda un plan anterior a las cuentas. No se carga solo por si no es tuyo. Si lo es, tráelo: sustituirá al actual.', previoCta: 'Traer ese plan', previoOk: 'Plan recuperado', entrar: 'Entrar', crear: 'Crear cuenta', aCrear: '¿Primera vez? Crea tu cuenta', aEntrar: '¿Ya tienes cuenta? Entra', olvide: 'He olvidado la contraseña', enviadoReset: 'Correo enviado: abre el enlace para cambiarla', nuevaClaveT: 'Elige una contraseña nueva', guardarClave: 'Guardar contraseña', cambiada: 'Contraseña cambiada: ya puedes entrar', confirmaCorreo: 'Confirma la cuenta desde tu correo y entra aquí', yaExiste: 'Ese correo ya tiene cuenta: entra con tu contraseña', errCred: 'Correo o contraseña incorrectos', errCorreo: 'Escribe un correo válido', errClaveCorta: 'Mínimo 8 caracteres', errRitmo: 'Demasiados intentos seguidos: espera un momento', errRed: 'Sin conexión con el servidor: prueba de nuevo', local: 'Tu plan va con tu cuenta a cualquier dispositivo. Solo tú lo ves.', ajustesSub: 'Tu plan vive en tu cuenta. Solo tú lo ves.', cerrarSesionNota: 'Tu plan queda en tu cuenta. Al entrar de nuevo sigues donde ibas.' },
    comp: { t: 'Compartir mi plan', nota: 'Enlace público de solo lectura a tu plan. Sin tu peso ni tus registros.', copiado: 'Enlace copiado', quitar: 'Dejar de compartir', quitado: 'Enlace desactivado', vT: 'El plan de {n}', vSub: 'Generado con BACK2PRIME', vCta: 'Hazte el tuyo', noExiste: 'Ese enlace no existe o su dueño lo desactivó', sem: '{s} semanas', dias: '{d} días/semana' },
  ...
  const PRODUCTOS = {
    ...
    aguacate: 'Aguacate',
    ajo: 'Ajo',
    alubias: 'Alubias negras cocidas',
    aove: 'Aceite de oliva virgen extra',
    arroz: 'Arroz',
    atun: 'Atún al natural',
    ...
    'harina-garbanzo': 'Harina de garbanzo',
    huevos: 'Huevos',
    hummus: 'Hummus',
    ...
    levadura: 'Levadura nutricional',
    limon: 'Limón',
    merluza: 'Merluza',
    nueces: 'Nueces',
    pan: 'Pan integral',
    'pan-sg': 'Pan sin gluten',
    'pasta-lentejas': 'Pasta de lentejas',
    patata: 'Patata',
    pepino: 'Pepino',
    pimiento: 'Pimiento',
    pipas: 'Pipas de calabaza',
    platano: 'Plátano',
    pollo: 'Pechuga de pollo',
    'prote-vegetal': 'Proteína vegetal en polvo',
    quinoa: 'Quinoa',
    sal: 'Sal',
    salmon: 'Salmón',
